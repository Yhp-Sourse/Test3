<template>
    <div class="Login">
        ...
        <el-form-item label="验证码" style="margin-left: 0px" prop="code">
              <div class="el-row" span="24">
                <div class="el-col el-col-16">
                  <el-input type="text" maxlength="4" placeholder="请输入验证码" prefix-icon=""
        ...
        <template>
            <div class="footer">
                <p>发布单位：湖北省生态环境监测中心站&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;技术支持：武汉天虹环保产业股份有限公司&nbsp;武汉雷特科技有限公司</p>
...
<style scoped>
  .Login{height:100vh;background: url(../assets/Images/hb_bj2.jpg)}
  .login-box {
    background: #fff;
  ...
  .footer{position: fixed;left: calc(50% - 290px);bottom: 10px;color:#fff;}
