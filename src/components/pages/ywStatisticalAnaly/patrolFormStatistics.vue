                        ...
                        <el-form :inline="true" class="demo-form-inline">
                         ...
                         <el-form-item label="">
                            ...
                            <el-form-item class="btn">
                                <el-button type="primary" icon="el-icon-search"  v-has="'patrolFormStatistics_handleSearch'"   @click="getList();">查询</el-button>
                                <el-button type="primary" icon="el-icon-download"  v-has="'patrolFormStatistics_handleExport'"   @click="download();">导出</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="tools">
      ...
      return {  
        ...
        page:{   //关于页码的相关参数
            ...
            columns: [
              ...
              {prop: 'reportName', label: '报表类型', width:180, align: 'center',isShow:true },
    ...
    methods:{          
       ...
       getSearchStations(obj){
        ...
        getList(obj){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/MaintenanceStatistics/GetPatrolTaskStatisticsByPage?pageSize=' + self.page.pageSize + '&pageIndex=' + self.page.pageNo+'&reportCode='+self.queryparam.ReportCode+' &stationIds='+self.queryparam.chooseStationIds+'&startTime='+self.queryparam.StartDate+'&endTime=' + self.queryparam.EndDate
            }).then(res => {
                if(res.status==200){
        ...
        download(obj){
            ...
            this.$http({
                ...
                url:  this.api+'/api/MaintenanceStatistics/GetPatrolTaskStatisticsDownLoad?pageSize=' + self.page.pageSize + '&pageIndex=' + self.page.pageNo+'&reportCode='+self.queryparam.ReportCode+' &stationIds='+self.queryparam.chooseStationIds+'&startTime='+self.queryparam.StartDate+'&endTime=' + self.queryparam.EndDate
            }).then(res => {
                if(res.status==200){              
