...
export default {
      ...
      return {  
        ...
        page:{   //关于页码的相关参数
            ...
            columns: [
              ...
              {prop: 'score1', label: '>=95分', width:180, align: 'center',isShow:true },
              {prop: 'score2', label: '>=90分', align: 'center',isShow:true },
              {prop: 'score3', label: '低于90分', align: 'center',isShow:true },
    ...
    methods:{
        ...
        getList(obj){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/OpsRanking/GetUnitRank?pageSize=' + self.page.pageSize + '&pageIndex=' + self.page.pageNo+'&ywOrg='+self.queryparam.YwOrg+ ' &searchTime=' + self.queryparam.SearchTime
            }).then(res => {
                if(res.status==200){
