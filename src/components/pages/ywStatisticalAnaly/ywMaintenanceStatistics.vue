                            ...
                            <div class="search">
                                <el-form :inline="true" class="demo-form-inline" size="mini">                                  
                                    <el-form-item label="任务状态：">
                                        <el-select v-model='queryparam.StatisticsType'   placeholder='请选择任务类型' style="width: 100%;">
                                             <el-option v-for='(item, index) in this.StatisticsTypeOptions' :key='index' :label='item.label' :value='item.value'></el-option>
                                        </el-select>                                    
                                    </el-form-item>                                  
                            ...
                            <div class="search">
                                <el-form :inline="true" class="demo-form-inline" size="mini">                            
                                    <el-form-item label="查询季度：">
                                        <rateQuarterSelect  
                                             :getValue="selectStartValue" 
                                             >
                                        </rateQuarterSelect>
                                    </el-form-item>
                                    <el-form-item label="-">
                                        <rateQuarterSelect  :getValue="selectEndValue" ></rateQuarterSelect>
                                    </el-form-item>
                                    
                                    <el-form-item class="btn">
                                        <el-button size="small" icon="el-icon-search" type="primary" @click="getList_Repair();">查询</el-button>
                                    </el-form-item>
                                </el-form>
                            </div>                        
                        </el-header>
                    ...
                    <el-header>
                        <div class="search">
                                <el-form :inline="true" class="demo-form-inline" size="mini">
                                    <el-form-item label="查询日期：">
                                        <el-date-picker
                                            v-model="queryparam_Alarm.StartDate"
                                            type="date"
                                            :clearable=false
                                            value-format="yyyy-MM-dd"
                                            placeholder="选择日期时间"
                                     ...
                                     <el-form-item label="-">
                                        <el-date-picker
                                            v-model="queryparam_Alarm.EndDate"
                                            type="date"
                                            :clearable=false
                                            value-format="yyyy-MM-dd"
                                            placeholder="选择日期时间"
                                    ...
                                    <el-form-item class="btn">
                                        <el-button size="small" icon="el-icon-search" type="primary" @click="getList_Alarm();">查询</el-button>
                                    </el-form-item>
                                </el-form>
                            </div>
                    </el-header>
                    ...
                    <el-header>
                        <div class="search">
                                <el-form :inline="true" class="demo-form-inline" size="mini">
                                    <el-form-item label="查询日期：">
                                        <el-date-picker
                                            v-model="queryparam_BeiJi.StartDate"
                                            type="date"
                                            :clearable=false
                                            value-format="yyyy-MM-dd"
                                            placeholder="选择日期时间"
                                     ...
                                     <el-form-item label="-">
                                         <el-date-picker
                                            v-model="queryparam_BeiJi.EndDate"
                                            type="date"
                                            :clearable=false
                                            value-format="yyyy-MM-dd"
                                            placeholder="选择日期时间"
                                    ...
                                    <el-form-item class="btn">
                                        <el-button size="small" icon="el-icon-search" type="primary" @click="getList_BeiJi();">查询</el-button>
                                    </el-form-item>
                                </el-form>
                            </div>
                    </el-header>
                    ...
                    <el-header>
                        <div class="search">
                                <el-form :inline="true" class="demo-form-inline" size="mini">
                                    <el-form-item label="查询日期：">
                                        <el-date-picker
                                            v-model="queryparam_Maintentance.StartDate"
                                            type="date"
                                            :clearable=false
                                            value-format="yyyy-MM-dd"
                                            placeholder="选择日期时间"
                                     ...
                                     <el-form-item label="-">
                                         <el-date-picker
                                            v-model="queryparam_Maintentance.EndDate"
                                            type="date"
                                            :clearable=false
                                            value-format="yyyy-MM-dd"
                                            placeholder="选择日期时间"
                                    ...
                                    <el-form-item class="btn">
                                        <el-button size="small" icon="el-icon-search" type="primary" @click="getList_Maintentance();">查询</el-button>
                                    </el-form-item>
                                </el-form>
                            </div>
                    </el-header>
        ...
        <el-tab-pane label="运维工作">
            <el-container style="height: calc(100vh - 145px); border: 1px solid #eee">
                <el-container>
                    <el-header>
                        <div class="search">
                                <el-form :inline="true" class="demo-form-inline" size="mini">
                                    <el-form-item label="查询日期：">
                                        <el-date-picker
                                            v-model="queryparam_YwWorkAndZhiKong.StartDate"
                                            type="date"
                                            :clearable=false
                                            value-format="yyyy-MM-dd"
                                            placeholder="选择日期时间"
                                    ...
                                    <el-form-item label="-">
                                         <el-date-picker
                                            v-model="queryparam_YwWorkAndZhiKong.EndDate"
                                            type="date"
                                            :clearable=false
                                            value-format="yyyy-MM-dd"
                                            placeholder="选择日期时间"
                                    ...
                                    <el-form-item class="btn">
                                        <el-button size="small" icon="el-icon-search" type="primary" @click="getList_YwWorkAndZhiKong();">查询</el-button>
                                    </el-form-item>
                                </el-form>
                            </div>
                    </el-header>
                    ...
                    <el-main>
                        <rate-table :list="list_YwWorkAndZhiKong"
...
export default {
    ...
    data(){
        return {
            ...
            columns: [
                ...
                { prop: 'status', label: '状态', width: 110, align: 'center' ,isShow:true }
            ],// 需要展示的列
            operates: {   //操作栏
                width:280,      
                fixed: 'right',
            ...
            page_Alarm:{   //关于页码的相关参数
                pageShow:true,  //是否显示分页
                total:0,        //总条数
                pageSize:10,    //每页条数
                pageNo:1,       //第几页
            },
            page_BeiJi:{   //关于页码的相关参数
                pageShow:true,  //是否显示分页
                total:0,        //总条数
                pageSize:10,    //每页条数
                pageNo:1,       //第几页
            ...
            page_YwWorkAndZhiKong:{   //关于页码的相关参数
                pageShow:true,  //是否显示分页
                total:0,        //总条数
                pageSize:10,    //每页条数
                pageNo:1,       //第几页
            ...
            options_Alarm: {  // table样式参数
                stripe: true, // 是否为斑马纹 table
                loading: false, // 是否添加表格loading加载动画
                highlightCurrentRow: true, // 是否支持当前行高亮显示
                mutiSelect: false, // 是否支持列表项选中功能
            }, // table 的参数结束
            options_BeiJi: {  // table样式参数
                stripe: true, // 是否为斑马纹 table
                loading: false, // 是否添加表格loading加载动画
                highlightCurrentRow: true, // 是否支持当前行高亮显示
                mutiSelect: false, // 是否支持列表项选中功能
            ...
            options_YwWorkAndZhiKong: {  // table样式参数
                stripe: true, // 是否为斑马纹 table
                loading: false, // 是否添加表格loading加载动画
                highlightCurrentRow: true, // 是否支持当前行高亮显示
                mutiSelect: false, // 是否支持列表项选中功能
            ...
            columns_Repair: [
                ...
                { prop: 'completeNum', label: '已检查站点数',  align: 'center' ,isShow:true,width:150,
                  formatter: (row, column, cellValue) => {
                    return '<a style="color:blue;"> '+row.completeNum+' </a>';
                  }
                },
                { prop: 'noCompleteNum', label: '未检查站点数', align: 'center' ,isShow:true },
                { prop: 'formulateNum', label: '已制定检查任务点位数', align: 'center',isShow:true,
                    formatter: (row, column, cellValue) => {
                       return '<a style="color:blue;"> '+row.formulateNum+' </a>';
                    }
                },
                { prop: 'noFormulateNum', label: '未制定检查任务点位数',align: 'center',isShow:true }
            ],// 需要展示的列
            columns_Scrap: [
                { prop: 'city', label: '城市', align: 'center',width:150 ,isShow:true },
                { prop: 'sStationName', label: '站点', align: 'center',isShow:true  },
                { prop: 'unitName', label: '运维单位', width: 110, align: 'center' ,isShow:true },
                { prop: 'qualityNum', label: '软件质控次数', align: 'center' ,isShow:true }
            ],// 需要展示的列
            columns_Alarm: [
                { prop: 'city', label: '城市', align: 'center',isShow:true },
                { prop: 'sStationName', label: '站点', align: 'center',isShow:true  },
                ...
                { prop: 'stateOver', label: '状态量超限', align: 'center' ,isShow:true },
                { prop: 'stateChange', label: '状态量数值变更提醒', align: 'center' ,isShow:false },
                { prop: 'stateApply', label: '状态量配置申请提醒',  align: 'center' ,isShow:false },
                { prop: 'devIn', label: '仪器设备接入', align: 'center' ,isShow:false },
                { prop: 'ycsj', label: '数据连续3小时不变', align: 'center' ,isShow:true },
                { prop: 'csx', label: '数据连续倒挂5小时',  align: 'center' ,isShow:true },
            ...
            columns_BeiJi: [
                { prop: 'city', label: '城市', align: 'center',width:150 ,isShow:true },
                { prop: 'sStationName', label: '站点', align: 'center',isShow:true  },
                { prop: 'replaceNum', label: '更换备机次数', width: 110, align: 'center' ,isShow:true },
                { prop: 'overdueUseNum', label: '超期使用次数', align: 'center' ,isShow:true },
                { prop: 'maxUseDay', label: '最大使用天数', align: 'center',isShow:true  }
            ],// 需要展示的列
            columns_Maintentance: [
                { prop: 'city', label: '城市', align: 'center',width:150 ,isShow:true },
                { prop: 'townName', label: '县市', align: 'center',isShow:true  },
                { prop: 'sStationName', label: '站点名称', width: 110, align: 'center' ,isShow:true },
                { prop: 'unitName', label: '运维单位', align: 'center' ,isShow:true },
                ...
                { prop: 'towMonthNum', label: '两月任务', align: 'center',isShow:true  },
           ...
           columns_YwWorkAndZhiKong: [
                ...
                { prop: 'sStationName', label: '站点名称', width: 110, align: 'center' ,isShow:true },
                { prop: 'unitName', label: '运维单位', align: 'center' ,isShow:true },
                { prop: 'planDealTime', label: '本次运维时间', align: 'center',isShow:true  },  
                { prop: 'lastPlanDealTime', label: '上次运维时间', align: 'center' ,isShow:true },
                { prop: 'aA', label: '距离上次运维时长(天)', align: 'center',isShow:true  },
                { prop: 'noCompletedContent', label: '待完成内容', align: 'center', width:300, isShow:true  },
                { prop: 'taskContent', label: '已完成内容', align: 'center', width:300,isShow:true  },
                { prop: 'isYwChart', label: '是否有运维数据曲线', align: 'center',isShow:false  },
                { prop: 'isQualified', label: '运维结果是否合格', align: 'center',isShow:false  },
                { prop: 'alarmResolve', label: '报警处理情况', align: 'center',isShow:false  },
                { prop: 'haveProblem', label: '存在的问题', align: 'center',isShow:false  }
            ],// 需要展示的列
    ...
    methods:{
        ...
        handleCellClick(obj){//单元格单击事件处理函数
            ...
            switch(obj.column.label){
                case "已检查站点数":                             
                this.$emit("jump", {param: "第四方检查任务",path: "/index/ywFourthInspectionTask",isjump: true,});   
                    break;
                case "已制定点位数":
                this.$emit("jump", {param: "第四方检查任务",path: "/index/ywFourthInspectionTask",isjump: true,});   
                    break;
       ...
       getNowTime() {
         ...
         this.$set(this.queryparam, "EndDate", defaultDate);
          ...
          //系统统计
         this.$set(this.queryparam_Scrap, "StartDate", beforedefaultDate);     
         this.$set(this.queryparam_Scrap, "EndDate", defaultDate);

         //报警统计
         this.$set(this.queryparam_Alarm, "StartDate", beforedefaultDate);     
         this.$set(this.queryparam_Alarm, "EndDate", defaultDate);

         //备机使用统计
         this.$set(this.queryparam_BeiJi, "StartDate", beforedefaultDate);     
         this.$set(this.queryparam_BeiJi, "EndDate", defaultDate);

         //运维统计报告
         this.$set(this.queryparam_Maintentance, "StartDate", beforedefaultDate);     
         this.$set(this.queryparam_Maintentance, "EndDate", defaultDate);

         //运维工作和质控报告
         this.$set(this.queryparam_YwWorkAndZhiKong, "StartDate", beforedefaultDate);     
         this.$set(this.queryparam_YwWorkAndZhiKong, "EndDate", defaultDate);
        },
        ...
        getCurrentPage_Alarm(val){  //table组件发射的方法  用于改变当前所在页码
            this.page_Alarm.pageNo=val;
            //这下面需要重新调用 获取列表页的函数
            this.getList_Alarm();
        },
        getCurrentPage_BeiJi(val){  //table组件发射的方法  用于改变当前所在页码
        ...
        getCurrentPage_YwWorkAndZhiKong(val){  //table组件发射的方法  用于改变当前所在页码
        ...
        getList(obj){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/MaintenanceStatistics/GetMaintenanceStatisticsByPage?pageSize=' + self.page.pageSize + '&pageIndex=' + self.page.pageNo+ '&StartDate=' + self.queryparam.StartDate + '&EndDate=' + self.queryparam.EndDate+ '&StatisticsType=' + self.queryparam.StatisticsType
            }).then(res => {
                if(res.status==200){
        ...
        getList_Repair(obj){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/MaintenanceStatistics/GetCityCheckCompletionByPage?pageSize=' + self.page_Repair.pageSize + '&pageIndex=' + self.page_Repair.pageNo+'&StartDate='+ self.queryparam_Repair.StartDate+'&EndDate='+self.queryparam_Repair.EndDate
            }).then(res => {
                if(res.status==200){
        ...
        getList_Scrap(obj){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/MaintenanceStatistics/GetQualityStatisticByPage?pageSize=' + self.page_Scrap.pageSize + '&pageIndex=' + self.page_Scrap.pageNo+'&StartDate='+ self.queryparam_Scrap.StartDate+'&EndDate='+self.queryparam_Scrap.EndDate
            }).then(res => {
                if(res.status==200){
        ...
        getList_Alarm(obj){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/MaintenanceStatistics/GetAlarmStatisticByPage?pageSize=' + self.page_Alarm.pageSize + '&pageIndex=' + self.page_Alarm.pageNo+'&StartDate='+ self.queryparam_Alarm.StartDate+'&EndDate='+self.queryparam_Alarm.EndDate
            }).then(res => {
                if(res.status==200){
        ...
        getList_BeiJi(obj){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/MaintenanceStatistics/GetBeiJiUseByPage?pageSize=' + self.page_BeiJi.pageSize + '&pageIndex=' + self.page_BeiJi.pageNo+'&StartDate='+ self.queryparam_BeiJi.StartDate+'&EndDate='+self.queryparam_BeiJi.EndDate
            }).then(res => {
                if(res.status==200){
        ...
        getList_Maintentance(obj){
            var self = this;
             //判断开始时间和结束时间
            if(self.queryparam_Maintentance.StartDate > self.queryparam_Maintentance.EndDate){
                    self.$message({
                    message: "查询开始时间不能大于查询结束时间!",
                    type: "warning"  });
                    return;
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/MaintenanceStatistics/GetOperationReportByPage?pageSize=' + self.page_Maintentance.pageSize + '&pageIndex=' + self.page_Maintentance.pageNo+'&StartDate='+ self.queryparam_Maintentance.StartDate+'&EndDate='+self.queryparam_Maintentance.EndDate
            }).then(res => {
                if(res.status==200){
        ...
        getList_YwWorkAndZhiKong(obj){
            var self = this;
             //判断开始时间和结束时间
            if(self.queryparam_YwWorkAndZhiKong.StartDate > self.queryparam_YwWorkAndZhiKong.EndDate){
                    self.$message({
                    message: "查询开始时间不能大于查询结束时间!",
                    type: "warning"  });
                    return;
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/MaintenanceStatistics/GetYwWorkAndZhiKongByPage?pageSize=' + self.page_YwWorkAndZhiKong.pageSize + '&pageIndex=' + self.page_YwWorkAndZhiKong.pageNo+'&City='+ self.queryparam_YwWorkAndZhiKong.City+'&StartDate='+ self.queryparam_YwWorkAndZhiKong.StartDate+' &EndDate='+self.queryparam_YwWorkAndZhiKong.EndDate
            }).then(res => {
                if(res.status==200){
    ...
    components:{
        treeSStation,rateTable,rateSelect,rateCascader,rateUpload,rateQuarterSelect
    },
    created(){
