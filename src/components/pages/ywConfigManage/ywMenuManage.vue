                    ...
                    <div class="search">
                        <el-form :inline="true" class="demo-form-inline">
                            <el-form-item label="菜单名称：">
                                <el-input v-model="queryparam.MenuName" placeholder="菜单名称"></el-input>
                            </el-form-item>                        
                            <el-form-item class="btn">
                                <el-button type="primary" icon="el-icon-search" v-has="'menu_handleSearch'" @click="getList();">查询</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="tools">
                         <el-button size="small" class=" el-button--iconButton" icon="el-icon-plus"  v-has="'menu_handleAdd'" style="text-overflow: initial;" @click="handleAdd">添加</el-button> 
                    </div>
                </el-header>
    ...
    <el-table-column label="操作" align =center>
      <template slot-scope="scope">
        ...
        <el-button
          size="mini"
          type="success"
         @click="handleFunction(scope.$index, scope.row)">分配按钮</el-button>
        <el-button
          size="mini"
          type="success"
       ...
       <div>
        ...
        <div>
                        ...
                        <el-col :span="12">
                            <div>
                                <el-form-item label="菜单名称：" prop="menu_name">
                                    <el-input v-model="ruleForm.menu_name" autocomplete="off"></el-input>
                                </el-form-item>
                            </div>
                        </el-col>
                        <el-col :span="12">
                             <div>
                                <el-form-item label="菜单路由：" prop="menu_url">
                                      <el-input v-model="ruleForm.menu_url" autocomplete="off"></el-input>
                                </el-form-item>
                        ...
                        <el-col :span="12">
                            <div>
                                <el-form-item label="父级菜单：" prop="menu_pid">
                                    <el-cascader :options="Menulist" :props="defaultProp"  @change="change"  placeholder="请选择父级菜单[不选则是顶级菜单]"
                        ...
                        <el-col :span="12">
                            <div>
                                <el-form-item label="菜单层级：" prop="menu_level">
                                      <el-input v-model="ruleForm.menu_level" autocomplete="off"></el-input>
                                </el-form-item>           
                            </div>
                        </el-col>                      
                    </el-row>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div>
                                 <el-form-item label="菜单排序：" prop="menu_order">
                                      <el-input v-model="ruleForm.menu_order" autocomplete="off"></el-input>
                                </el-form-item>      
                        ...
                        <el-col :span="12">
                            <div>
                                ...
                                <el-select v-model="ruleForm.menu_icon" placeholder="请选择图标"  @change="changeIcon">
                        ...
                        <el-col :span="12">
                            <div>
                                 <el-form-item label="菜单标识：" prop="menu_identify">
                                      <el-input v-model="ruleForm.menu_identify" autocomplete="off"></el-input>
                                </el-form-item>      
                         ...
                         <el-col :span="6">
                            <div>
                                <el-form-item label="是否启用：" prop="menu_status">
                                    <el-radio-group v-model="ruleForm.menu_status">
                        ...
                        <el-col :span="24">
                            <div>
                                <el-form-item label="菜单描述：" prop="menu_description">
                                    <el-input v-model="ruleForm.menu_description" autocomplete="off" :rows="3" type="textarea"></el-input>
                                </el-form-item>
                            </div>
                        </el-col>                      
                    </el-row>
            ...
            <el-dialog
                ...
                height="30%"
                >
                 <el-form :model="ruleIconForm" status-icon :rules="rules" ref="ruleIconForm" label-width="100px" class="demo-ruleForm" size="mini">                 
                      <el-row>
                        <el-col :span="24">
                        <div> 
                                  <el-checkbox :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange">全选</el-checkbox>
                                       <div style="margin: 15px 0;"></div>
                                           <el-checkbox-group v-model="ruleIconForm.checkList" @change="handleCheckedCitiesChange">
                                               <el-checkbox v-for="data in ruleIconForm.funList" :label="data.fun_Id" :key="data.fun_Id">{{data.fun_name}}</el-checkbox>
                                  </el-checkbox-group>
                   ...
                   <el-row>
                        ...
                        <el-col :span="12">
                            <div> 
                               <el-form-item>
                                    <el-button type="primary" @click="handleFunSave()">提交</el-button>
...
<script>
  ...
  export default {
    ...
    data() {   
      return { 
        ...
        rules: {
            ...
            menu_url: [{ required: true, message: '请输入菜单地址', trigger: 'blur' }],
            menu_level: [{ required: true, message: '请输入菜单层级', trigger: 'blur' }],
            menu_order: [{ required: true, message: '请输入菜单排序', trigger: 'blur' }],
            menu_pid: [{ required: true, message: '请输入父级菜单', trigger: 'blur' }],
            menu_identify: [{ required: true, message: '请输入菜单标识', trigger: 'blur' }],
        },
        queryparam:{
            MenuName:'',
        },
    ...
    handleCheckedCitiesChange(value) {
        ...
        this.isIndeterminate = checkedCount > 0 && checkedCount <  this.ruleIconForm.funList.length;
      },
      ...
      handleFunction(index, row){
                ...
                if(res.status==200){
                    self.ruleIconForm.checkList=res.data.data;
                       if(self.ruleIconForm.checkList.length==0)
                       {
                           ...
                           this.checkAll=false;      
                        }else if(self.ruleIconForm.checkList.length!=0 &&self.ruleIconForm.checkList.length!=self.ruleIconForm.funList.length){
       ...
       handleSizeChange(val) {   //每页显示多少条
        ...
        handleFunSave(){
           ...
           this.$http({
                method: 'GET',
                url: self.api+'/api/Yw_Sys_Menu/AddMenuFun?menuId='+ self.menuId + '&meunIdentify='+self.meunIdentify +'&funIds=' + iconIds
            }).then(res => {
                if(res.status==200){                
        ...
        getList(obj){      
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/Yw_Sys_Menu/GetMenuTree?pageSize=' + self.page.pageSize + '&pageIndex=' + self.page.pageNo+ '&menuName=' + self.queryparam.MenuName
            }).then(res => {
                if(res.status==200){
...
.el-table{height: calc(100vh - 310px) !important;}
.el-select{width:100%;}
