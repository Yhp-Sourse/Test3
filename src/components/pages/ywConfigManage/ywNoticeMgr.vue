    ...
    <div id="v_deviceOnlineInfo">
                    ...
                    <div class="search">
                        <el-form :inline="true" class="demo-form-inline">
                            <el-form-item label="标题：">
                                <el-input v-model="queryparam.noticeTitle" placeholder="请输入标题"></el-input>
                            </el-form-item>
                           ...
                           <el-form-item label="创建时间：">
                            ...
                            <el-form-item class="btn">
                                <el-button type="primary" icon="el-icon-search"   v-has="'noticeMgr_handleSearch'"  @click="getList();">查询</el-button>
                                <el-button type="primary" icon="el-icon-download"  @click="download();">导出</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="tools">
                         <el-button size="small" class=" el-button--iconButton" icon="el-icon-plus"  v-has="'noticeMgr_handleAdd'"  style="text-overflow: initial;" @click="handleAdd">添加</el-button> 
                         <el-button size="small" class=" el-button--iconButton" icon="el-icon-delete"  v-has="'noticeMgr_handleMultiplDel'"  style="text-overflow: initial;" @click="handleMultiplDel">删除</el-button>
                    </div>
                </el-header>
        ...
        <div>
                        ...
                        <el-col :span="12">
                            <div> 
                                <el-form-item label="通知类型：" prop="NoticeType">                                
                                   <el-select v-model='ruleForm.NoticeType'   placeholder='请选择通知类型' style="width: 100%;">
                                       <el-option v-for='(item, index) in ruleForm.NoticeTypeOptions' :key='index' :label='item.label' :value='item.value'></el-option>
                                   </el-select>
                                </el-form-item>
                            </div>                   
                        </el-col>
                        ...
                        <el-col :span="24">
                            <div> 
                                <el-form-item label="通知内容：" prop="Content">
                                    <el-input v-model="ruleForm.Content" autocomplete="off" type="textarea" :rows="4"></el-input>
                                </el-form-item>
                            </div>                   
                        </el-col>                      
                    </el-row> 
          ...
          <el-dialog
                ...
                >                  
                <el-form :model="ruleForm1" status-icon :rules="rules1" ref="ruleForm1" label-width="100px" class="demo-ruleForm1" size="mini">                   
                    <el-row>                      
                        <el-col :span="12">
                            <div> 
                                <el-form-item v-show="true" label="相关附件：" prop="FileURL">
                                     <rateUpload :limit="1"  :Ismultiple="false" :BusinessId="ruleForm1.NoticeId" :BusinessType="31"
                                     @uploadSuccess="uploadSuccess" ></rateUpload>
                                 </el-form-item>
                            </div>                   
                        </el-col>                      
                    </el-row> 
...
export default {
      ...
      return {          
        ...
        page:{   //关于页码的相关参数
            ...
            columns: [
              ...
              {prop: 'show_NoticeType', label: '类型', width:180,align: 'center',isShow:true },
              ...
              {prop: 'show_CreateTime', label: '创建时间', align: 'center',isShow:true },
    ...
    methods:{  
        ...
        uploadSuccess(file) {
           ...
           this.$http({
               method: 'GET',
                url: this.api+'/api/Yw_NoticeMgr/YwUpdateNoticeFujian?noticeId=' + this.ruleForm1.NoticeId + '&fileName=' + this.ruleForm1.FileName +' &fileUrl=' + this.ruleForm1.FileURL              
            }).then(res => {
                if(res.status==200){
                   self.$message({
        ...
        getList(obj){      
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/Yw_NoticeMgr/GetAllNotice?pageSize=' + self.page.pageSize + '&pageIndex=' + self.page.pageNo+'&Title='+self.queryparam.noticeTitle+'&StartTime=' +self.queryparam.startTime+' &EndTime=' + self.queryparam.endTime
            }).then(res => {
                if(res.status==200){
        ...
        download(obj){
            ...
            this.$http({
                ...
                url: this.api+'/api/Yw_NoticeMgr/GetAllNoticeDownLoad?pageSize=' + self.page.pageSize + '&pageIndex=' + self.page.pageNo+'&Title='+self.queryparam.noticeTitle+'&StartTime=' +self.queryparam.startTime+' &EndTime=' + self.queryparam.endTime
            }).then(res => {
                if(res.status==200){              
