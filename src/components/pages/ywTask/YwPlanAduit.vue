...
<template>
    <iframe src="http://218.76.24.159:8028/Maintaince/Login/Index" width="100%" height="800" frameborder="0" scrolling="auto"></iframe>
</template>
...
export default{
    ...
    methods:{
        ...
        getTaskList(){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/Yw_Task/GetTaskList?pagesize=' + self.page.pageSize + '&pageindex=' + self.page.pageNo
            }).then(res => {
                console.log(res);
                if(res.status==200){
