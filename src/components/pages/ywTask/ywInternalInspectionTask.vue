                        ...
                        <el-form :inline="true" class="demo-form-inline">  
                          ...
                          <el-form-item label="检查日期：">
                            ...
                            <el-form-item class="btn">
                                <el-button type="primary" icon="el-icon-search"  v-has="'ywInternalInspectionTask_handleSearch'"    @click="getList();">查询</el-button>
                                 <el-button type="primary" icon="el-icon-download"  v-has="'ywInternalInspectionTask_handleExport'"  @click="download();">导出</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="tools">
                         ...
                         <el-button size="small" class=" el-button--iconButton" icon="el-icon-s-promotion" v-has="'ywInternalInspectionTask_handleArrangement'"  style="text-overflow: initial;" @click="handleArrangement">领取</el-button>
                         <el-button size="small" class=" el-button--iconButton" icon="el-icon-delete" v-has="'ywInternalInspectionTask_handleMultiplDel'"  style="text-overflow: initial;" @click="handleMultiplDel">删除</el-button>
                         <el-button size="small" class=" el-button--iconButton" icon="el-icon-right" v-has="'ywInternalInspectionTask_handleRecall'"  style="text-overflow: initial;" @click="handleBatchCancel">撤回</el-button>
                    </div>
                </el-header>
...
export default {
      ...
      return {         
        ...
        page:{   //关于页码的相关参数
            ...
            columns: [
              ...
              {prop: 'show_GenModifyProblem', label: '内部是否确认', align: 'center',isShow:true },
              {prop: 'unitName', label: '运维单位', align: 'center',isShow:true },
              {prop: 'unitName', label: '检查单位', align: 'center',isShow:true },//checkCompany
              ...
              list: [
                    {
                      ...
                      hasbutton:'ywInternalInspectionTask_handleEdit',
                      ...
                      hasbutton:'ywInternalInspectionTask_handleOperate',
                      disabled: false,   //是否禁用按钮 默认是danger的禁用样式
                      method: (index, row) => {
                        var self = this;
                        if(row.status==1){
                      ...
                      show: true,   //是否显示按钮                      
                      className:'info', //样式类名
                      hasbutton:'ywInternalInspectionTask_handleDetail',
                      disabled: false,   //是否禁用按钮 默认是danger的禁用样式
                      method: (index, row) => {
    ...
    methods:{     
        ...
        handleOperate (index, row) {  //操作栏编辑按钮
            ...
            this.$emit('jump',{param:'内部检查任务窗口',path:'/index/ywInternalInspectionTaskShow?obj='+JSON.stringify(obj),isjump:true});  
            //关闭当前tab
    ...
    const fileName = downTime +'-内部检查任务.xls';
