    ...
    data(){
        return{
          ...
          rules: {
            ...
            id_hg: [{ required: true, message: '必填项，没有的填写“/”', trigger: 'blur' }],
            id_bhg:[{ required: true, message: '必填项，没有的填写“/”', trigger: 'blur' }],
            id_bz: [{ required: true, message: '必填项，没有的填写“/”', trigger: 'blur' }]
          },
        }
    },
    // computed: {
