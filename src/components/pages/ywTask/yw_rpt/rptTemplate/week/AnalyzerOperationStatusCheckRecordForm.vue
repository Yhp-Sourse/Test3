    ...
    <div>
        ...
        <table id="tb2" style="">
            ...
            <tr>
                ...
                <td colspan="2">
                    <el-form-item label="" prop="rc_7">
                       <input type="text" @blur='checkKeydown("rc_7",1)' value="" v-model="ruleForm.rc_7"  id="rc_7" style="height: 30px;">
                    </el-form-item>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><el-form-item label="" prop="rc_11"><input @blur='checkKeydown("rc_11",2)' v-model="ruleForm.rc_11" id="rc_11" type="text" value="" style="height: 30px;"></el-form-item></td>
            ...
            <tr>
                ...
                <td><el-form-item label="" prop="rc_16"><input @blur='checkKeydown("rc_16",2)' v-model="ruleForm.rc_16" id="rc_16" type="text" value="" style="height: 30px;"></el-form-item></td>
