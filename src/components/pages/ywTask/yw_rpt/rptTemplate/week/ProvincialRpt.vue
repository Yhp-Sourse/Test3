<template>
    <div>
    <el-form id="ASEmergency" :model="ruleForm" :rules="rules" ref="Form" >
        <table id="tb2" style="">
            <tbody>
            <tr style="">
            ...
            <tr>
                ...
                <td><el-form-item label="" prop="rc_11"><input id="rc_11" @blur='checkKeydown("rc_11",2)' v-model="ruleForm.rc_11" type="text" value="" style="height: 30px;"></el-form-item></td>
            ...
            <tr>
                ...
                <td><el-form-item label="" prop="rc_16"><input id="rc_16" @blur='checkKeydown("rc_16",2)' v-model="ruleForm.rc_16" type="text" value="" style="height: 30px;"></el-form-item></td>
            ...
            <tr>
                ...
                <td colspan="5"><el-form-item label="" prop="rc_18"><input id="rc_18" @blur='checkKeydown("rc_18",2)' v-model="ruleForm.rc_18" type="text" value="" style="height: 30px;"></el-form-item></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2"><span id="td_27">650±10% ml/min（API），300～900ml/min（天虹），580～720 sccm（聚光），0.350～0.750L/min (赛默飞)，0.4～0.8 SLPM（EC），650±65ml/min(新先河)</span></td>
