    ...
    <el-form id="ASEmergency" :model="ruleForm" :rules="rules" ref="Form" :label-position="top" >
        <table id="tb2" style="">
            ...
            <tr>
                ...
                <td><el-form-item label="" prop="rc_11"><input id="rc_11" @blur='checkKeydown("rc_11",1)' v-model="ruleForm.rc_11"  type="text" value="" style="height: 30px;"></el-form-item></td>
            ...
            <tr>
                ...
                <td><el-form-item label="" prop="rc_16"><input id="rc_16" @blur='checkKeydown("rc_16",1)' v-model="ruleForm.rc_16"  type="text" value="" style="height: 30px;"></el-form-item></td>
            ...
            <tr>
                ...
                <td colspan="5"><el-form-item label="" prop="rc_18"><input id="rc_18" @blur='checkKeydown("rc_18",1)' v-model="ruleForm.rc_18"  type="text" value="" style="height: 30px;"></el-form-item></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2"><span id="td_25">2500～4800 mv(API)，1.5～4.096v(聚光)，500～4800mV(ESA)，45000～150000HZ(赛默飞)，0.2～1 v(天虹)，2000～4900 mv(新先河)，300～6500 mV(新天虹)</span></td>
            ...
            <tr>
                ...
                <td colspan="2"><span id="td_27">2500～4800 mv(API)，1.5～4.096v(聚光)，500～4800mV(ESA)，45000～150000HZ(赛默飞)，0.2～1 v(天虹)，2000～4900 mv(新先河)，300～6500 mV(新天虹)</span></td>
