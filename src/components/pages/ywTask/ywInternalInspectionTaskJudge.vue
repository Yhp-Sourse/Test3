                        ...
                        <el-form :inline="true" class="demo-form-inline">  
                          ...
                          <el-form-item label="创建日期：">
                            ...
                            <el-form-item class="btn">
                                <el-button type="primary" icon="el-icon-search" v-has="'ywInternalInspectionTaskJudge_handleSearch'"    @click="getList();">查询</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="tools">  
...
export default {
              ...
              list: [
                    {
                      ...
                      hasbutton:'ywInternalInspectionTaskJudge_handleSure',
                      ...
                      show: true,   //是否显示按钮                      
                      className:'success', //样式类名
                      hasbutton:'ywInternalInspectionTaskJudge_handleDetail',
                      disabled: false,   //是否禁用按钮 默认是danger的禁用样式
                      method: (index, row) => {
    ...
    methods:{           
        ...
        handleOperate (index, row) {  //操作栏编辑按钮
            ...
            //关闭当前tab
            this.$emit("closeCurrentPage", "内部任务整改"); //调用closeCurrentPage方法注意；两点1：第二个参数必须是string，2：长度必须大于等于4       
        },
