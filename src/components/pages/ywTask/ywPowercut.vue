<template>
  <div id="v_ywPowercut">
          ...
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="状态" v-if="false">
                <el-select v-model="queryparam.QState" placeholder="不限" style="width: 100%;">
                  <el-option
              ...
              <el-form-item class="btn">
                <el-button type="primary" v-has="'ywPowercut_handleSearch'" icon="el-icon-search" @click="getList();">查询</el-button>
                <el-button type="primary" icon="el-icon-download"  v-has="'ywPowercut_handleExport'"    @click="download();">导出</el-button>
          ...
          >
            <template slot-scope="scope">
              <el-tooltip class="item" effect="dark" content="编辑" placement="top">
                <el-link type="primary" @click="handleEdit(scope.row,scope.row)" >编辑</el-link>
              </el-tooltip>
            </template>
          </el-table-column>
        </el-table>
    ...
    <!--停电记录-->
    <div>
      <el-dialog title="停电记录" :visible.sync="dialogVisible" width="70%">
        <el-form
          :model="ruleForm"
          status-icon
          :rules="rules"
        ...
        >
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="无效小时:" prop="InvalidHour">
                  <el-input v-model="ruleForm.InvalidHour" autocomplete="off"></el-input>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="停电时间:" prop="StartTime">
                  <el-date-picker v-model="ruleForm.StartTime" type="datetime" placeholder="选择日期"></el-date-picker>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="12">
              <div>
                <el-form-item label="结束时间:" prop="EndTime">
                  <el-date-picker v-model="ruleForm.EndTime" type="datetime" placeholder="选择日期"></el-date-picker>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-table :data="tableData" style="width: 100%">
              ...
              <el-table-column prop="Startdate" label="停电开始时间" width="280">
                 <template slot-scope="scope">         
                  <el-date-picker v-model="scope.row.Startdate" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期"></el-date-picker>
                </template>
              </el-table-column>
              <el-table-column prop="Enddate" label="停电结束时间" width="280">
                 <template slot-scope="scope">         
                  <el-date-picker v-model="scope.row.Enddate" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期"></el-date-picker>
                </template>
              </el-table-column>
              <el-table-column prop="Startdate" label="稳定开始时间" width="280">
                 <template slot-scope="scope">         
                  <el-date-picker v-model="scope.row.WDStartdate" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期"></el-date-picker>
                </template>
              </el-table-column>
              <el-table-column prop="Enddate" label="稳定结束时间" width="280">
                 <template slot-scope="scope">         
                  <el-date-picker v-model="scope.row.WDEnddate" type="datetime" value-format="yyyy-MM-dd HH:mm:ss"  placeholder="选择日期"></el-date-picker>
                </template>
              </el-table-column>
            </el-table>
          </el-row>
          ...
          <el-row v-show="ruleForm.Id>0">
           ...
           <el-form-item>
            <el-button v-if="!isMenusave" type="primary" @click="submitForm('ruleForm','1')">保存</el-button>
            <!--<el-button v-if="!isMenuActive" type="primary" @click="submitForm('ruleForm','2')">提交</el-button>-->
            <el-button v-if="!isMenucheck" type="primary" @click="ShowCheck('ruleForm','4')">审核</el-button>
            <!--<el-button v-if="!isMenureset" @click="resetForm('ruleForm')">重置</el-button>-->
          </el-form-item>
        </el-form>
      </el-dialog>

       <el-dialog title="停电记录审核" :visible.sync="dialogVisibleCheck" width="50%">
        <el-form
          :model="check"
          status-icon
          :rules="rules"
        ...
        <el-form-item label="审核结果:" prop="Results">
                  ...
                  <el-input
                    ...
                    :autosize="{ minRows: 2, maxRows: 4}"
                    placeholder="请输入内容"
                    v-model="check.Reason"
                  ></el-input>
                </el-form-item>
                 <el-form-item>
            <el-button type="primary" @click="saveForm('check')">确定</el-button>
          </el-form-item>
                 </el-form>
       </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        SStation: [{ required: true,  message:"请选择站点名称:",trigger: "blur" }],
        InvalidHour: [
          { required: true, message: "请输入无效小时", trigger: "blur" },
        ],
        StartTime: [{ required: true, message: "请选择开始时间", trigger: "blur" }],
        EndTime: [{ required: true, message: "请选择结束时间", trigger: "blur" }],
        BlackoutType: [{ required: true, message: "请选择停电类别", trigger: "blur" }],
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$http({
            ...
            method: "post",
            url: self.api+'/api/Yw_Powercut/OutageRecordInfoSubmit?jsonStr=' + jsonStr,
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$http({
            ...
            url:
              self.api +
              "/api/Yw_Powercut/OutageRecord_Audit",
