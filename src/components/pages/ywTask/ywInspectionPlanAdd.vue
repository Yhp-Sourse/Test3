      ...
      <el-main>
        ...
        >
          ...
          <el-row>
            <el-col :span="24">
                <div>
                   <rateAuditRecord typeCode="003002" :isSave='isSave' :active="ruleForm.Status" :businessType='31' :businessId='ruleForm.PlanNo.toString()' :auditerId='aduitForm.AuditerId' :result='aduitForm.Result' :reason='aduitForm.Reason'></rateAuditRecord>
                </div>
            </el-col>
          </el-row>
          ...
          <div>
            <el-collapse v-model="activeNames" @change="handleChange">
                  ...
                  <el-col :span="14">
                    <div>
                        <el-form-item label="检查方式：" prop="PlanCatetory">
                            <el-select v-model='ruleForm.PlanCatetory'  disabled  placeholder='请选择检查方式' style="width: 100%;">
                                <el-option v-for='item in PlanCatetoryOptions' :key='item.value' :label='item.label' :value='item.value'></el-option>
                            </el-select>
                        </el-form-item>
                    </div>
                  </el-col>
                  ...
                  <el-col :span="14">
                    <div>
                        <el-form-item label="计划状态：" prop="Status">
                            <el-select v-model='ruleForm.Status'  disabled  placeholder='请选择计划状态' style="width: 100%;">
              ...
              <el-collapse-item title="检查计划详情" name="2">
                 <el-row>
                   <div class="tools">
                        <el-button size="small" class=" el-button--iconButton" icon="el-icon-plus" style="text-overflow: initial;" @click="handleTaskPlanDetialAdd">添加</el-button>
                    </div>
                 </el-row>
                <el-row>              
                   <el-col :span="24">
        ...
        <div>
          <el-dialog title="审核明细" :visible.sync="aduitFormDialogVisible" width="30%">
            <el-form
              :model="aduitForm"
              status-icon
              ref="aduitForm"
                        ...
                        <el-col :span="12">
                            <div>
                                <el-form-item label="计划类型：" prop="TaskCategoryId">                                   
                                    <rate-select
                                    v-model="ruleForm1.TaskCategoryId"
                        ...
                        <el-col :span="12">
                            <div> 
                                <el-form-item label="计划时间：" prop="PlanDealTime">
                                     <el-date-picker
                                               v-model="ruleForm1.PlanDealTime"
                                               type="date"   
                                                :clearable=false                                          
                        ...
                        <el-col :span="24">
                            <div>
                                <el-form-item label="备注：" prop="ItemRemark">
                                    <el-input type="textarea" v-model="ruleForm1.ItemRemark" autocomplete="off"></el-input>
                                </el-form-item>
                            </div>
                        </el-col>                        
                    </el-row>
...
export default {
  ...
  data() {
    ...
    fromTab:'',
      ...
      rules1: {
           TaskCategoryId: [{ required: true, message: '请选择计划类型', trigger: 'blur' }],
           PlanDealTime: [{ required: true, message: '请选择时间', trigger: 'blur' }],
      },
      ...
      options: {  // table样式参数
       ...
       columns: [
          ...
          {prop: 'categoryName',label: '计划类型',align: 'center',isShow:true},//formatter重构//return `返回参数`
          {prop: 'show_PlanDealTime',label: '描述',align: 'center',isShow:true,width:200},
  ...
  methods: {
    //弹出审核窗体
     ...
     handleTaskDetialDel(index, row){
          ...
          this.$http({
                method: 'GET',
                url: this.api+'/api/InspectionPlan/DeleteTaskPlanItem?id=' + row.itemId
            }).then(res => {
                if(res.status==200){
    ...
    handleReturn() {
      var self =this;
      this.$emit("closeCurrentPage", "检查计划窗口"); //调用closeCurrentPage方法注意；两点1：第二个参数必须是string，2：长度必须大于等于4
    ...
    getTaskPlanDetailList(planNo){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/InspectionPlan/GetTaskPlanItem?pageSize=' + self.page.pageSize + '&pageIndex=' + self.page.pageNo+ '&PlanNo=' + planNo 
            }).then(res => {
                if(res.status==200){
