                        ...
                        <el-form :inline="true" class="demo-form-inline">
                         <el-form-item label="日期类型：">                              
                            ...
                            <el-form-item class="btn">
                                <el-button type="primary" icon="el-icon-search"   v-has="'ywReport_handleSearch'"  @click="cal_ywMonth">计算运维数据</el-button>
                                <el-button type="primary" icon="el-icon-download"   v-has="'ywReport_handleGenerate'"  @click="downloadReport">导出报表</el-button>
                            </el-form-item>
                        </el-form>
                    </div>                    
                </el-header>   
...
export default {
    ...
    methods:{ 
       ...
       cal_ywMonth(){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/Yw_Report/CalYwMonthReport?stime=' + self.queryparam.SearchTime
            }).then(res => {
                if(res.status==200){               
                    self.$message({
       ...
       downloadReport(){
           ...
           self.loading=true;
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/Yw_Report/ProduceYwReport?stime=' + self.queryparam.SearchTime + '&dateType='+type
