                    ...
                    <div class="search">
                        <el-form :inline="true" class="demo-form-inline" >
                            <el-form-item label="材料名称：">
                                <el-input v-model="queryparam.materialname" placeholder="输入材料名称"></el-input>
                            </el-form-item>
                            ...
                            <el-form-item class="btn">
                                <el-button type="primary" v-has="'ywConsume_handleSearch'" icon="el-icon-search" @click="getList();">查询</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
                    <div class="tools">
                        <el-button size="small" v-has="'ywConsume_handleAdd'" class=" el-button--iconButton" icon="el-icon-plus" style="text-overflow: initial;" @click="handleAdd">添加</el-button>
                        <el-button size="small" v-has="'ywConsume_handleMultiplDel'" class=" el-button--iconButton" icon="el-icon-delete" style="text-overflow: initial;" @click="handleMultiplDel">删除</el-button>
                    </div>
                </el-header>
                ...
                <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" size="mini">
                        ...
                        <el-col :span="12">
                            <div> 
                                <el-form-item label="保质期：" prop="Garanteeperiod">
                                    <el-date-picker v-model="ruleForm.Garanteeperiod" type="date" placeholder="选择日期"></el-date-picker>
                                </el-form-item>
                            </div>
                        </el-col>
                    </el-row>
                        ...
                        <el-col :span="12">
                            <div>
                                <el-form-item label="材料名称：" prop="MaterialName">
                                    <el-input v-model="ruleForm.MaterialName" autocomplete="off"></el-input></el-form-item>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div> 
                        ...
                        <el-col :span="12">
                            <div>
                                <el-form-item label="使用数量：" prop="Usedquantity">
                                    <el-input v-model="ruleForm.Usedquantity" autocomplete="off"></el-input>
                                </el-form-item>
                            </div>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="12">
                            <div>
                                <el-form-item label="型号：" prop="TypeModel">
                                    <el-input v-model="ruleForm.TypeModel" autocomplete="off"></el-input>
                                </el-form-item>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div v-if="false"> 
                                <el-form-item label="数量：" prop="Quantity">
                                    <el-input v-model="ruleForm.Quantity" autocomplete="off"></el-input>
                                </el-form-item>
                            </div>
                        </el-col>
                    </el-row>
                   ...
                   <el-row>
                        ...
                        <el-col :span="6">
                            <div> 
                               <el-form-item>
                                    <el-button type="primary" v-has="'ywConsume_handleSubmit'" @click="submitForm('ruleForm')">提交</el-button>
...
export default {
    ...
    data() {
      return {
        ...
        rules: {
            ...
            Usedquantity: [{ required: true, message: '请输入已用数量', trigger: 'blur' }],
            Company: [{ required: true, message: '请输入单位', trigger: 'blur' }],
            Garanteeperiod: [{ required: true, message: '请输入保质期', trigger: 'blur' }],
        },
        queryparam:{
            StartDate:'',
            EndDate:'',
        ...
        columns: [
          {prop: 'city',label: '城市',align: 'center',isShow:true,formatter: (row, column, cellValue) => {return row.city;}},//formatter重构//return `返回参数`
          {prop: 'sstationname',label: '站点名称',align: 'center',isShow:true,width:200},
          {prop: 'materialname',label: '材料名称',align: 'center',isShow:true},
          ...
          {prop: 'usedquantity',label: '使用数量',align: 'center',isShow:true},
          {prop: 'company',label: '单位',align: 'center',isShow:true},
          {prop: 'show_Garanteeperiod',label: '保质期',align: 'center',isShow:true,width:100},
          {prop: 'entryperson',label: '录入人',align: 'center',isShow:true},
          {prop: 'show_entrytime',label: '录入时间',align: 'center',isShow:true,width:100},
        ],// 需要展示的列
        operates: {   //操作栏
          width:200,      
          fixed: 'right',
    ...
    methods:{
        ...
        getList(obj){
            ...
            this.$http({
                method: 'GET',
                url: this.api+'/api/Yw_Consumables/GetList?pagesize=' + self.page.pageSize + '&pageindex=' + self.page.pageNo+ '&startDate=' + self.queryparam.StartDate + '&endDate=' + self.queryparam.EndDate+'&sstation='+self.queryparam.chooseStationIds +'&materialname=' + self.queryparam.materialname
            }).then(res => {
                if(res.status==200){
    ...
    components:{
        treeSStation,rateTable,rateCascader
    },
    mounted() {
