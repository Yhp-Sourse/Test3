          ...
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="设备型号">
                <el-input v-model="queryparam.QModel" placeholder="设备型号"></el-input>
              </el-form-item>
              ...
              <el-form-item class="btn">
                <el-button type="primary" v_has="'DevOnli_handleSearch'" icon="el-icon-search" @click="getList();">查询</el-button>
                <el-button type="primary" icon="el-icon-download"   @click="download();">导出</el-button>
                <el-button type="primary" icon="el-icon-refresh"   @click="refresh();">数据同步</el-button>
              </el-form-item>
            </el-form>
          </div>
          <div class="tools">
      ...
      <el-dialog title="编辑" :visible.sync="dialogVisible" width="50%">
        ...
        >
          ...
          <el-form-item label="设备厂家" prop="FacId">
            <el-select v-model="ruleForm.FacId" placeholder="不限" style="width: 100%;">
              <el-option
  ...
  methods: {
   ...
   refresh(){
      ...
      this.$http({
        method: "GET",
        url:
          this.api +"/api/Yw_Equipment/SynchronousData",
      })
        .then((res) => {
          if (res.status == 200) {
               self.$message({
