  ...
  <div id="v_deviceSparePartInfo">
    <el-container style="height: calc(100vh - 102px); border: 1px solid #eee">
      ...
      <el-container>
        <el-header>
          <div class="search">
            <el-form :inline="true" :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" size="mini">
              <el-form-item label="标气品种：" label-width="100px" prop="variety">
                    <el-select
                     clearable 
                      v-model="queryparam.variety"
                      placeholder="请选择"
                      style="width: 100%;"
                    >
                    <el-option
                ...
                <el-form-item label="生产单位:" label-width="100px">
                  <el-select style="width:100%;" clearable v-model="queryparam.production" placeholder="请选择">
                      <el-option label="中国计量科学研究院" value="中国计量科学研究院"></el-option>
                      <el-option label="生态环境部环境发展中心环境标准样品研究所" value="生态环境部环境发展中心环境标准样品研究所"></el-option>
                  </el-select>
              ...
              <el-form-item class="btn">
                <el-button type="primary" icon="el-icon-search" v-has="'devStandardGas_handleSearch'"  @click="getList();">查询</el-button>
                <el-button type="primary" icon="el-icon-download" v-has="'devStandardGas_handleExport'"  @click="downloadBeiJi();">导出</el-button>
              </el-form-item>
            </el-form>
          </div>
          <div class="tools">
            <el-button
              ...
              @click="handleAdd"
            >添加</el-button>
            <el-button size="small" class=" el-button--iconButton" icon="el-icon-unlock"  v-has="'ywTask_handleUnlock'"  style="text-overflow: initial;" @click="handleBatchJS">解锁</el-button>
                        <el-button size="small" class=" el-button--iconButton" icon="el-icon-lock"  v-has="'ywTask_handlelock'"  style="text-overflow: initial;" @click="handleBatchSuoD">锁定</el-button>
          </div>
        </el-header>
        <el-main>
          <rate-table
    ...
    <div>
      ...
      <el-dialog title="标准气体" :visible.sync="dialogVisible" width="60%">
        <el-form
          :model="ruleForm"
          status-icon
          :rules="rules"
        ...
        >
          <el-row>
            ...
            <el-col :span="12">
                 <el-form-item label="站点名称："  label-width="120px" prop="SStationName">
                    <rateCascader
          ...
          <el-row>
            <el-col :span="12">
                <el-form-item label="标气品种："  label-width="120px" prop="variety">
                    <el-select
                      v-model="ruleForm.variety"
                      placeholder="请选择"
                      style="width: 100%;"
                    >
                    <el-option
            ...
            <el-col :span="12">
                <el-form-item label="生产单位:"  label-width="120px" prop="production">
                  <el-select style="width:100%;" v-model="ruleForm.production" placeholder="请选择学历">
                      <el-option label="中国计量科学研究院" value="中国计量科学研究院"></el-option>
                      <el-option label="生态环境部环境发展中心环境标准样品研究所" value="生态环境部环境发展中心环境标准样品研究所"></el-option>
                  </el-select>
                  <!-- <el-input v-model="ruleForm.production" autocomplete="off"></el-input> -->
          ...
          <el-row>
            <el-col :span="12">
                <el-form-item label="样品编号:"  label-width="120px" prop="sampleId">
                    <el-input v-model="ruleForm.sampleId" autocomplete="off"></el-input>
                </el-form-item>
            </el-col>
            <el-col :span="12">
                <el-form-item label="运维人员："  label-width="120px" prop="ywPerson">
                  <el-input v-model="ruleForm.ywPerson" autocomplete="off"></el-input>
                </el-form-item>
            </el-col>
          </el-row>
            <el-row>
            <el-col :span="12">
                <el-form-item label="定值日期:" label-width="120px" prop="dzDate">
                     <el-date-picker style='width:100%;'
                      ...
                      format="yyyy 年 MM 月 dd 日"
                      value-format="yyyy-MM-dd"
                      v-model="ruleForm.dzDate" 
                      placeholder="选择日期"></el-date-picker>
                </el-form-item>
            </el-col>
            <el-col :span="12">
                <el-form-item label="保值时间(月):"  label-width="120px" prop="bzdate">
                    <el-input v-model="ruleForm.bzdate" @change="change2" autocomplete="off"></el-input>
                </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12"><p v-show="false">{{validDate}}</p>
                <el-form-item label="有效期至:"  label-width="120px" prop="validDate">
                   <el-date-picker style='width:100%;'
            ...
            <el-col :span="12"><p v-show="false">{{nextChangeDays}}</p>
                <el-form-item label="下次更换时间(天)："  label-width="140px" prop="nextChangeDays">
                  <el-input v-model="ruleForm.nextChangeDays" autocomplete="off"></el-input>
                </el-form-item>
            </el-col>
          </el-row>
            <el-row>
            <el-col :span="12">
                <el-form-item label="出产单位电话："  label-width="120px" prop="productionPhone">
                  <el-input v-model="ruleForm.productionPhone" autocomplete="off"></el-input>
                </el-form-item>
            </el-col>
             <el-col :span="12">
                <el-form-item label="出产单位地址："  label-width="120px" prop="productionAddress">
                  <el-input v-model="ruleForm.productionAddress" autocomplete="off"></el-input>
                </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
                <el-form-item label="项目名称："  label-width="120px" prop="projectName">
                  <el-input v-model="ruleForm.projectName" autocomplete="off"></el-input>
                </el-form-item>
            </el-col>
            <el-col :span="12">
                  <el-form-item v-show="true" label="资质证书："  label-width="120px" prop="certificate">
                    <rateUpload
                        :limit="1"
                        :Ismultiple="false"
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        {prop: 'islock',label: '是否锁定',align: 'center',isShow:true,width:80,formatter:this.islock},
        {prop: "city",label: "城市",width: 180,align: "center",isShow: true},
        {prop: "townName",label: "县域",width: 180,align: "center",isShow: true},
        {prop: "stn",label: "站点名称",width: 180,align: "center",isShow: true},
        {prop: "show_stnType",label: "站点类型",width: 180,align: "center",isShow: true},
        {prop: "variety",label: "标气品种",width: 180,align: "center",isShow: true},
        {prop: "production",label: "生产单位",width: 180,align: "center",isShow: true},
        {prop: "sampleId",label: "样品编号",width: 180,align: "center",isShow: true},
        {
          prop: "certificate",
          label: "资质证书",
          width: 200,
        ...
        {prop: "show_dzDate",label: "定值日期",width: 180,align: "center",isShow: true},
        {prop: "bzdate",label: "保值时间(月)",width: 180,align: "center",isShow: true},
        {prop: "show_validDate",label: "有效期至",width: 180,align: "center",isShow: true},
        {prop: "show_nextChangeDays",label: "下次更换时间(天)",width: 180,align: "center",isShow: true},
        {prop: "productionPhone",label: "出产单位电话",width: 180,align: "center",isShow: true},
        {prop: "productionAddress",label: "出产单位地址",width: 280,align: "center",isShow: true},
        {prop: "projectName",label: "项目名称",width: 280,align: "center",isShow: true},
        {prop: "ywPerson",label: "运维人员",width: 180,align: "center",isShow: true},
      ], // 需要展示的列
      operates: {
        //操作栏
        width: 250,
  ...
  methods: {
      ...
      AddMouth(date, num)
            ...
            change1(value){
              if(this.ruleForm.dzDate!="" && this.ruleForm.bzdate!=""){
                this.ruleForm.validDate=this.AddMouth(this.ruleForm.dzDate,this.ruleForm.bzdate);
                this.ruleForm.nextChangeDays=this.GetNumberOfDays(new Date(),this.ruleForm.validDate);
              }
            },
            change2(value){
              if(this.ruleForm.dzDate!="" && this.ruleForm.bzdate!=""){
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$http({
            ...
            url:
              self.api +
              "/api/Yw_DeviceSparePartInfo/DevStandardGas_Save",
    ...
    Singelmultipl(id) {
      ...
      this.$http({
        ...
        url:
          self.api +
          "/api/Yw_DeviceSparePartInfo/DevStandardGasDel?Id=" +
          id,
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    getToFirst(id) {
      ...
      this.$http({
        ...
        url:
          this.api +
          "/api/Yw_DeviceSparePartInfo/DevStandardGasById?Id=" +
          id,
      })
        .then((res) => {
          if (res.status == 200) {
