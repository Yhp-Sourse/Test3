        ...
        <el-header>
          <div style="margin: 10px;float:left">
            <el-form :inline="true" class="demo-form-inline">
              <img class="ins_msg" style="float:left;" src="../../../assets/Images/ins_whl.jpg" />
              <div style="width:50%;margin: 5px;float:left">
                <el-form-item style="float:left;color: #333;" label=" 品牌：">{{query.FacName}}</el-form-item>
                <el-form-item style="float:left;color: #333;" label=" 型号：">{{query.Model}}</el-form-item>
              </div>
            </el-form>
          </div>
        </el-header>
        <el-main>
          <el-tabs v-model="activeName" style="width:71.5%; float: left;" @tab-click="handleClick">
           ...
           <div class="layui-card-body" style="width: 25%; float: right;box-shadow: 0px 2px 5px 0px rgba(0, 0, 0, 0.35);">
            <div style="width: 200px; height: 60px; background: rgb(202, 221, 254); border-radius: 8px; text-align: center; line-height: 60px; margin: 10px auto;font-weight:bold;font-size:18px; ">设备生命周期</div>
          <el-timeline :reverse="reverse">
            <el-timeline-item 
              ...
              :type="type"
              :size="size"
            :timestamp="Show_ProductionDate" placement="top">
           ...
           <el-timeline-item 
            :key="index"
              ...
              :type="type"
              :size="size"
           :timestamp="Show_ShelfTime" placement="top">
            ...
            <el-timeline-item
              ...
              :type="type"
              :size="size"
              :timestamp="activity.show_ChangeTime" placement="top"
            > <el-card><p>{{activity.changeReason}} </p></el-card></el-timeline-item>
          </el-timeline>
            </div>
        </el-main>
      </el-container>
