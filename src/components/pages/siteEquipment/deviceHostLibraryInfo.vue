<template>
  <div id="v_deviceHostLibraryInfo">
          ...
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="设备厂家">
                <el-input v-model="queryparam.QName" placeholder="设备厂家"></el-input>
              </el-form-item>
              <el-form-item label="参数">
                <el-select v-model="queryparam.QParam" placeholder="不限" style="width: 100%;">
                  <el-option
              ...
              <el-form-item label="状态">
                <el-select v-model="queryparam.QStatus" placeholder="不限" style="width: 100%;">
                  <el-option
              ...
              <el-form-item class="btn">
                <el-button type="primary" v-has="'DevHost_handleSearch'" icon="el-icon-search"  @click="getList();">查询</el-button>
                <el-button type="primary"  icon="el-icon-download"   @click="downloadZhuJi();">导出</el-button>
    ...
    <div>
      <el-dialog title="主机设备" :visible.sync="dialogVisible" width="50%">
        <el-form
          :model="ruleForm"
          status-icon
          :rules="rules"
        ...
        >
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="监测参数：" prop="Param">
                  <el-select v-model="ruleForm.Param" placeholder="不限" style="width: 100%;">
                    <el-option
              ...
              <div>
                <el-form-item label="厂家名称：" prop="FacId">
                  <el-select
                    ...
                    placeholder="请选择"
                    @click.native="getModel(ruleForm.FacId,ruleForm.Param)"
                    style="width: 100%;"
                  >
                    <el-option
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="验收日期：" prop="ShelfTime">
                  <el-date-picker v-model="ruleForm.ShelfTime" type="date" placeholder="选择日期"></el-date-picker>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="12">
              <div>
                <el-form-item label="唯一识别码（出厂编号）:" prop="DeviceUniqueCode">
          ...
          <el-row>
            <el-col :span="12">
              <div>
                <el-form-item label="生产日期（出厂日期）:" prop="ProductionDate">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        DeviceCode: [{ required: true, message: "请输入设备型号", trigger: "blur" }],
        DeviceUniqueCode: [{ required: false, message: "请输入唯一识别码", trigger: "blur" }],
      },
      queryparam: {
        QName: "",
        QParam: "",
