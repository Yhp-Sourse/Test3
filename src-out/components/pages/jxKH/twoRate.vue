  ...
  <div>
    <el-container style="height: calc(100vh - 102px); border: 1px solid #eee">
      <el-aside width="250px">
        <treeSStation
          @checkedNodes="getList"
          @checkedNodes2="checkSStation"
        ></treeSStation>
      </el-aside>
    ...
    <div>
      <el-dialog title="日期选择" v-model:visible="dialogVisible" width="50%">
        <el-form
          :model="ruleForm"
          status-icon
          :rules="rules"
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="开始日期：">
                <el-date-picker
                  v-model:value="queryparam.Start"
                  type="date"
                  placeholder="选择开始日期"
...
export default {
  ...
  methods: {
    ...
    submitForm(formName) {
      var self = this
      if (
        self.queryparam.SStation == null ||
        self.queryparam.SStation.length <= 0
      ) {
    ...
    download(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Jx/GetTwoRateListDownLoad?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&UnitId=' +
