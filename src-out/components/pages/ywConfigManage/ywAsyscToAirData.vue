          ...
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item label="表单状态:">
                ...
                >
                  <el-option
                    v-for="item in YwFromStatusOptions"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value"
                  ></el-option>
              ...
              <el-form-item class="btn">
                <el-button
                  type="primary"
                  v-has="'asyscToAirData_handleSearch'"
                  icon="el-icon-search"
                  @click="getList()"
                  >查询</el-button
                >
                <el-button
                  type="primary"
                  v-has="'asyscToAirData_handleAnSync'"
...
export default {
  ...
  methods: {
    ...
    getNowTime() {
      ...
      this.queryparam['startDate'] = defaultDate
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_Rpt/GetRptList?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&startDate=' +
    ...
    asycData() {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_Rpt/YwRptToAirDb?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&startDate=' +
