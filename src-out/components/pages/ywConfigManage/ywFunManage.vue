          ...
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="按钮名称">
                <el-input
                  v-model:value="queryparam.FunName"
                  placeholder="按钮名称"
                ></el-input>
              </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        fun_icon: [
          { required: true, message: '请选择按钮图标', trigger: 'blur' },
        ],
        fun_method: [
          { required: true, message: '请方法名称', trigger: 'blur' },
        ],
  ...
  methods: {
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_Function/GetFunPageList?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          '&funName=' +
          self.queryparam.FunName,
      })
        .then((res) => {
          if (res.status == 200) {
