          ...
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="登录账号">
                <el-input
                  v-model:value="queryparam.LoginCode"
                  placeholder="请输入登录账号"
                ></el-input>
              </el-form-item>
              ...
              <el-form-item label="角色名称">
                <rate-select
                  v-model:value="rateSelectRoleType.model"
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="登录账号：" prop="usr_name">
                  <el-input
                    v-model:value="ruleForm.usr_name"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </div>
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="登录密码：" prop="usr_pwd">
                  <el-input
                    v-model:value="ruleForm.usr_pwd"
                    autocomplete="off"
                    :disabled="isWrite"
                    show-password
                  ></el-input>
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="用户站点：" prop="usr_station">
                  <rateCascader
                    :checkStrictly="true"
                    :selectOption="ruleForm.usr_station"
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="运维单位：" prop="usr_unitid">
                  <rate-select
                    v-model:value="ruleForm.usr_unitid"
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="用户姓名：" prop="usr_realname">
                  <el-input
                    v-model:value="ruleForm.usr_realname"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </div>
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="角色选择：" prop="role_id">
                  <rate-select
                    v-model:value="ruleForm.role_id"
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="联系电话：" prop="usr_phone">
                  <el-input
                    v-model:value="ruleForm.usr_phone"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </div>
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="性 别：" prop="usr_sex">
                  <el-select
                    v-model:value="ruleForm.usr_sex"
                    placeholder="请选择性别"
                    style="width: 100%"
                  >
                    <el-option
                      v-for="(item, index) in ruleForm.SexOptions"
                      :key="index"
                      :label="item.label"
                      :value="item.value"
                    ></el-option>
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="上级领导：" prop="usr_dleaderid">
                  <rate-select
                    v-model:value="ruleForm.usr_dleaderid"
            ...
            <el-col :span="6">
              <div>
                <el-form-item label="是否启用：" prop="usr_status">
                  <el-radio-group v-model:value="ruleForm.usr_status">
            ...
            <el-col :span="6">
              <div>
                <el-form-item label="是否管理员: " prop="usr_isadmin">
                  <el-radio-group v-model:value="ruleForm.usr_isadmin">
                    <el-radio :label="1">是</el-radio>
                    <el-radio :label="0">否</el-radio>
                  </el-radio-group>
                </el-form-item>
            ...
            <el-col :span="24">
              <div>
                <el-form-item label="用户描述：" prop="usr_description">
                  <el-input
                    v-model:value="ruleForm.usr_description"
                    autocomplete="off"
                    type="textarea"
                    :rows="3"
                  ></el-input>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        usr_station: [
          { required: true, message: '请选择用户站点', trigger: 'blur' },
        ],
        usr_unitid: [
      ...
      columns: [
        ...
        },
        {
          ...
          formatter(row, column, cellValue) {
            if (row.usr_phone == null || row.usr_phone == '') {
              //表示被锁定
              return '-'
            } else {
        ...
        },
        {
          ...
          isShow: true,
          formatter(row, column, cellValue) {
            if (row.usr_dleadername == null || row.usr_dleadername == '') {
              //表示被锁定
              return '-'
            } else {
  ...
  methods: {
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_UsrManage/GetUsrPageList?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          '&stationId=' +
          ...
          '&loginCode=' +
          self.queryparam.LoginCode +
          '&ywOrg=' +
          self.queryparam.YwOrg +
          '&realName=' +
          self.queryparam.RealName +
          '&roleType=' +
          self.queryparam.RoleType,
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    download(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_UsrManage/GetUsrListDownLoad?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          '&stationId=' +
