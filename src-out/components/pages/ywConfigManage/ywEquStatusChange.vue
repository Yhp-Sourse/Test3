            ...
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item class="btn">
                <el-button
                  type="primary"
                  icon="el-icon-search"
                  v-has="'equStatusChange_handleSearch'"
                  @click="getList()"
                  >查询</el-button
                >
              </el-form-item>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          prop: 'after_lower_limit',
          label: '申请下限',
          align: 'center',
          isShow: true,
        },
        {
          prop: 'before_upper_limit',
          label: '原上限',
          align: 'center',
          isShow: true,
        },
        {
          prop: 'after_upper_limit',
          label: '申请上限',
          align: 'center',
          isShow: true,
        },
        {
          prop: 'before_critical_time',
          label: '原持续周期报警',
          align: 'center',
          isShow: true,
        },
        {
          prop: 'after_critical_time',
          label: '申请持续周期报警',
          align: 'center',
          isShow: true,
        },
        {
          prop: 'show_Before_state_key',
          label: '原是否关键参数',
          align: 'center',
          isShow: true,
        },
        {
          prop: 'show_After_state_key',
          label: '申请是否关键参数',
          align: 'center',
          isShow: true,
        },
  ...
  methods: {
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_VarStatus/GetEquStatusChangeMessage?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          ' &sStaion=' +
