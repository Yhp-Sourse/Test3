...
export default {
  ...
  methods: {
    ...
    handleNodeClick(data, node, self) {
      //共三个参IsCheckOn数，依次为：传递给 data 属性的数组中该节点所对应的对象、节点本身是否被选中、节点的子树中是否有被选中的节点
      this.checktype = false
      //var sstation=this.$refs.tree.getCheckedNodes(false,true);
      var sstation = this.$refs.tree.getCheckedNodes(false, false)
      $emit(this, 'checkedNodes', sstation)
    },
    setCheckedNodes() {
      //设置树节点选中
      this.checktype = true
