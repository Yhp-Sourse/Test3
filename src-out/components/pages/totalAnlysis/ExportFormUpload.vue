    ...
    <el-container style="height: calc(100vh - 105px); border: 1px solid #eee">
      ...
      <el-container>
          ...
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="站点：" prop="chooseStationIds">
                <rateCascader
                  :checkStrictly="false"
                  :selectOption="queryparam.chooseStationIds"
        ...
        <el-main
          id="exportWord"
          v-if="
            queryparam.chooseStationIds != null &&
            queryparam.chooseStationIds != '' &&
        ...
        >
          <div v-for="(item, index) in upfileArr" :key="index">
            ...
            <span v-for="(w, i) in item" :key="i" style="display: inline-block">
              <ExportFormUpload
                :filelist="w.isUpload ? w.name : ''"
                :formType="index"
                :isUpload="w.isUpload"
                :title="w.name"
                :CreatedTime="queryparam.Month"
                :BusinessType="w.reportCode"
                :BusinessId="w.week + w.reportCode"
                :SStation="queryparam.chooseStationIds"
                @uploadSuccess="uploadSuccess"
                @handleuplodRemove="handleuplodRemove"
              />
            </span>
          </div>
    ...
    return {
      ...
      upfileArr: {
        week1: [
          ...
          {
            week: 1,
            name: 'SO<sub>2</sub>分析仪运行状况检查记录表',
            reportCode: '010102',
            isUpload: false,
          },
          {
            week: 1,
            name: 'NO<sub>x</sub>分析仪运行状况检查记录表',
            reportCode: '010103',
            isUpload: false,
          },
          {
            week: 1,
            name: 'O<sub>3</sub>分析仪运行状况检查记录表',
            reportCode: '010104',
            isUpload: false,
          },
          {
          ...
          {
            week: 1,
            name: '颗粒物分析仪PM<sub>10</sub>运行状况检查记录表',
            reportCode: '010106',
            isUpload: false,
          },
          {
            week: 1,
            name: '颗粒物分析仪PM<sub>2.5</sub>运行状况检查记录表',
            reportCode: '010107',
            isUpload: false,
          },
          {
        ...
        month: [
          {
            isUpload: false,
            week: 6,
            name: '颗粒物PM<sub>2.5</sub>监测仪流量测试与校准记录',
            reportCode: '010201',
          },
          {
            isUpload: false,
          ...
          },
          {
            isUpload: false,
            week: 6,
            name: '颗粒物PM<sub>10</sub>监测仪流量测试与校准记录',
            reportCode: '010205',
          },
          {
            isUpload: false,
          ...
          },
          {
            isUpload: false,
            week: 6,
            name: 'PM<sub>10</sub>分析仪温湿度、气压和时钟检查校准',
            reportCode: '010207',
          },
          {
            isUpload: false,
            week: 6,
            name: 'PM<sub>2.5</sub>分析仪温湿度、气压和时钟检查校准',
            reportCode: '010208',
          },
        ],
        towMonth: [
        ...
        quarter: [
          {
            isUpload: false,
            week: 8,
            name: 'SO<sub>2</sub>分析仪多点校准记录',
            reportCode: '020101',
          },
          {
            isUpload: false,
            week: 8,
            name: 'NO<sub>x</sub>分析仪多点校准记录',
            reportCode: '020102',
          },
          {
            isUpload: false,
          ...
          },
          {
            isUpload: false,
            week: 8,
            name: 'O<sub>3</sub>分析仪多点校准记录',
            reportCode: '020104',
          },
          {
            isUpload: false,
            week: 8,
            name: 'SO<sub>2</sub>分析仪精密度审核记录',
            reportCode: '020105',
          },
          {
            isUpload: false,
            week: 8,
            name: 'NO<sub>x</sub>分析仪精密度审核记录',
            reportCode: '020106',
          },
          {
            isUpload: false,
          ...
          },
          {
            isUpload: false,
            week: 8,
            name: 'O<sub>3</sub>分析仪精密度审核记录',
            reportCode: '020108',
          },
          {
            isUpload: false,
            week: 8,
            name: 'β射线法颗粒物PM<sub>2.5</sub>自动监测分析仪检查记录',
            reportCode: '020109',
          },
          {
            isUpload: false,
            week: 8,
            name: 'β射线法颗粒物PM<sub>10</sub>自动监测分析仪检查记录',
            reportCode: '020110',
          },
          {
            isUpload: false,
            week: 8,
            name: '微量振荡天平法颗粒物PM<sub>10</sub>监测仪环境温度和压力校准表',
            reportCode: '020111',
          },
          {
            isUpload: false,
            week: 8,
            name: '微量振荡天平法颗粒物PM<sub>2.5</sub>监测仪环境温度和压力校准表',
            reportCode: '020112',
          },
          {
            isUpload: false,
        ...
        oneyear: [
          ...
          },
          {
            isUpload: false,
            week: 10,
            name: 'SO<sub>2</sub>分析仪准确度审核记录表',
            reportCode: '020302',
          },
          {
            isUpload: false,
            week: 10,
            name: 'NO<sub>x</sub>分析仪准确度审核记录表',
            reportCode: '020303',
          },
          {
            isUpload: false,
          ...
          },
          {
            isUpload: false,
            week: 10,
            name: 'O<sub>3</sub>分析仪准确度审核记录表',
            reportCode: '020305',
          },
          {
            isUpload: false,
            week: 10,
            name: '微量振荡天平法颗粒物PM<sub>10</sub>监测仪质量传感器校准表',
            reportCode: '020306',
          },
          {
            isUpload: false,
            week: 10,
            name: '微量振荡天平法颗粒物PM<sub>2.5</sub>监测仪质量传感器校准表',
            reportCode: '020307',
          },
          {
            isUpload: false,
          ...
          },
          {
            isUpload: false,
            week: 10,
            name: '颗粒物（PM<sub>10</sub>）手工比对记录表',
            reportCode: '020310',
          },
          {
            isUpload: false,
            week: 10,
            name: '颗粒物（PM<sub>2.5</sub>）手工比对记录表',
            reportCode: '020311',
          },
          {
            isUpload: false,
  ...
  methods: {
    getList() {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Upload/GetExportFormUpload?CreatedTime=' +
          self.queryparam.Month +
          '&SStation=' +
    ...
    handleuplodRemove(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Common/DeleteFile?CreatedTime=' +
          obj.CreatedTime +
          '&SStation=' +
          obj.SStation +
          '&BusinessId=' +
