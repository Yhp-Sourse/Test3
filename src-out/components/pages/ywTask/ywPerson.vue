<template>
  <div id="v_ywUnit">
    ...
    <div>
      <el-dialog title="运维单位" v-model:visible="dialogVisible" width="50%">
        <el-form
          :model="ruleForm"
          status-icon
          :rules="rules"
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="排序：" prop="SortOrder">
                  <el-input
                    v-model:value="ruleForm.SortOrder"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </div>
  ...
  methods: {
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_Person/GetList?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&usr_unitid=' +
          self.queryparam.usr_unitid,
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    download(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_Person/GetListDownLoad?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&usr_unitid=' +
