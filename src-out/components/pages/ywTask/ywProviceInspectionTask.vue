        ...
        <el-header>
            ...
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item class="btn">
                <el-button
                  type="primary"
                  icon="el-icon-search"
                  v-has="'ywProviceInspectionTask_handleSearch'"
                  @click="getList()"
                  >查询</el-button
                >
                <el-button
                  ...
                  v-has="'ywProviceInspectionTask_handleExport'"
                  @click="download()"
                  >导出</el-button
                >
              </el-form-item>
          ...
          <div class="tools">
            ...
            <el-button
              ...
              v-has="'ywProviceInspectionTask_handleArrangement'"
              style="text-overflow: initial"
            ...
            <el-button
              ...
              class="el-button--iconButton"
              icon="el-icon-delete"
              v-has="'ywProviceInspectionTask_handleMultiplDel'"
              style="text-overflow: initial"
            ...
            <el-button
              ...
              class="el-button--iconButton"
              icon="el-icon-delete"
              v-has="'ywProviceInspectionTask_handleRecall'"
              style="text-overflow: initial"
...
export default {
  ...
  methods: {
    ...
    handleOperate(index, row) {
      ...
      //关闭当前tab
      $emit(this, 'closeCurrentPage', '省站检查任务') //调用closeCurrentPage方法注意；两点1：第二个参数必须是string，2：长度必须大于等于4
    },
