<template>
  <div id="v_ywArrivalRecord">
        ...
        <el-header>
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item class="btn">
                <el-button
                  type="primary"
                  v-has="'arrivalRecord_handleSearch'"
                  icon="el-icon-search"
                  @click="getList()"
                  >查询</el-button
                >
                <el-button
                  ...
                  v-has="'arrivalRecord_handleExport'"
                  @click="download()"
                  >导出</el-button
                >
              </el-form-item>
          ...
          <div class="tools">
            ...
            <el-button
              ...
              icon="el-icon-delete"
              style="text-overflow: initial"
              v-has="'arrivalRecord_handleMultiplDel'"
    ...
    <div>
      <el-dialog title="进站记录" v-model:visible="dialogVisible" width="50%">
        <el-form
          :model="ruleForm"
          status-icon
          :rules="rules"
            ...
            <el-col :span="24">
              <div>
                <rateAuditRecord
                  ...
                  :businessType="3"
                  :businessId="ruleForm.Id.toString()"
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="进站时间：" prop="ArrivalTime">
                  <el-date-picker
                    v-model:value="ruleForm.ArrivalTime"
                    type="datetime"
                    placeholder="选择时间"
                  ></el-date-picker>
                </el-form-item>
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="出站时间：" prop="OutTime">
                  <el-date-picker
                    v-model:value="ruleForm.OutTime"
                    type="datetime"
                    placeholder="选择时间"
                  ></el-date-picker>
                </el-form-item>
              ...
              <div>
                <el-form-item>
                  ...
                  <el-button
                    ...
                    type="primary"
                    @click="aduitFormDialogVisible = !aduitFormDialogVisible"
                    >审核</el-button
                  >
  ...
  data() {
    return {
      ...
      rules: {
        ...
        ArrivalTime: [
          { required: true, message: '请输入进站时间', trigger: 'blur' },
        ],
        OutTime: [
          { required: true, message: '请输入出站时间', trigger: 'blur' },
        ],
        Reason: [
          { required: false, message: '请输入进站原因', trigger: 'blur' },
        ],
  ...
  methods: {
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_ArrivalLog/GetList?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&SStation=' +
    ...
    download(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_ArrivalLog/GetListDownLoad?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&SStation= ' +
