        ...
        <el-header>
            ...
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item class="btn">
                <el-button
                  type="primary"
                  icon="el-icon-search"
                  v-has="'ywFourthInspectionTask_handleSearch'"
                  @click="getList()"
                  >查询</el-button
                >
                <el-button
                  ...
                  v-has="'ywFourthInspectionTask_handleExport'"
                  @click="download()"
                  >导出</el-button
                >
              </el-form-item>
          ...
          <div class="tools">
            <el-button
              ...
              icon="el-icon-plus"
              v-has="'ywFourthInspectionTask_handleAdd'"
            ...
            <el-button
              ...
              v-has="'ywFourthInspectionTask_handleArrangement'"
              style="text-overflow: initial"
            ...
            <el-button
              ...
              class="el-button--iconButton"
              icon="el-icon-delete"
              v-has="'ywFourthInspectionTask_handleMultiplDel'"
              style="text-overflow: initial"
            ...
            <el-button
              ...
              class="el-button--iconButton"
              icon="el-icon-right"
              v-has="'ywFourthInspectionTask_handleRecall'"
              style="text-overflow: initial"
...
export default {
  ...
  methods: {
    ...
    handleOperate(index, row) {
      ...
      $emit(this, 'jump', {
        param: '第四方检查任务窗口',
        path: '/index/ywFourthInspectionTaskShow?obj=' + JSON.stringify(obj),
        isjump: true,
      })
      //关闭当前tab
      $emit(this, 'closeCurrentPage', '第四方检查任务') //调用closeCurrentPage方法注意；两点1：第二个参数必须是string，2：长度必须大于等于4
    },
    ...
    handleBatchCancel() {
      ...
      this.handleSelection.forEach((item, index) => {
        ...
        if (item.status >= 2 && item.status < 8) {
          ...
          tips +=
            '选中第' + (index + 1) + '行不能撤回,领取后,但未完成的任务才能撤回!'
        }
      })
      if (tips != '') {
        self.$message({
