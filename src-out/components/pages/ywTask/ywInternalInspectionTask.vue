        ...
        <el-header>
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item label="任务状态：">
                ...
                >
                  <el-option
                    v-for="(item, index) in this.StatusOptions"
                    :key="index"
                    :label="item.label"
                    :value="item.value"
                  ></el-option>
              ...
              <el-form-item class="btn">
                <el-button
                  type="primary"
                  icon="el-icon-search"
                  v-has="'ywInternalInspectionTask_handleSearch'"
                  @click="getList()"
                  >查询</el-button
                >
                <el-button
                  ...
                  v-has="'ywInternalInspectionTask_handleExport'"
                  @click="download()"
                  >导出</el-button
                >
              </el-form-item>
          ...
          <div class="tools">
            <el-button
              ...
              icon="el-icon-plus"
              v-has="'ywInternalInspectionTask_handleAdd'"
            ...
            <el-button
              ...
              v-has="'ywInternalInspectionTask_handleArrangement'"
              style="text-overflow: initial"
            ...
            <el-button
              ...
              class="el-button--iconButton"
              icon="el-icon-delete"
              v-has="'ywInternalInspectionTask_handleMultiplDel'"
              style="text-overflow: initial"
            ...
            <el-button
              ...
              class="el-button--iconButton"
              icon="el-icon-right"
              v-has="'ywInternalInspectionTask_handleRecall'"
              style="text-overflow: initial"
...
export default {
  ...
  methods: {
    ...
    handleOperate(index, row) {
      ...
      $emit(this, 'jump', {
        param: '内部检查任务窗口',
        path: '/index/ywInternalInspectionTaskShow?obj=' + JSON.stringify(obj),
        isjump: true,
      })
      //关闭当前tab
    ...
    ArrangeTask(ids) {
      ...
      this.$http({
        ...
        url:
          self.api +
          '/api/FourthInspectionTask/ArrangeMentFourthTask?taskNo=' +
          ids,
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/InspectionPlan/GetInspectionTaskByPage?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          '&SStation=' +
    ...
    download(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/InspectionPlan/GetInspectionTaskDownLoad?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          '&SStation=' +
