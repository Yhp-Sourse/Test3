    ...
    <el-main id="exportPDF">
      ...
      <div class="image beizhu" style="position: relative">
        <span v-for="(g, index) in files" :key="index">
          ...
          <i
            ...
            @click="deleteImg(g.fileGUID, g.fileURL)"
            v-if="isShowPicWall"
          ></i>
        </span>
      </div>
      ...
      <div class="foot">
        <rptFooter
          :footerData="taskData"
          @rpt_sava="rpt_sava"
          @rpt_submit="rpt_submit"
          @rpt_success="rpt_success"
          @rpt_refuse="rpt_refuse"
        ></rptFooter>
      </div>
    </el-main>
  </el-container>
  ...
  methods: {
    ...
    getRptToFirst(val, TaskNo) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_Rpt/GetRptToFirst?ReportCode=' +
          val +
          '&TaskCode=' +
          TaskNo,
      })
    ...
    getParam() {
      ...
      this.$http({
        method: 'GET',
        url:
          this.api + '/api/Yw_Rpt/GetReptFormFirst?reportType=' + self.rptType,
      })
        .then((res) => {
          if (res.data.code == 200) {
    ...
    handleReturn() {
      ...
      var obj = {
        ...
        firstButtonType: this.firstButtonType,
    ...
    selectOptionEvent(val) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_Rpt/GetToFirst?ReportCode=' +
          val +
          '&TaskNo=' +
          this.TaskNo,
      })
