  ...
  <div id="taskDisplay">
    <el-container style="height: calc(100vh - 102px); border: 1px solid #eee">
      ...
      <el-main>
                  ...
                  <el-col :span="14">
                    <div>
                      <el-form-item label="任务类别：" prop="TaskCategoryId">
                        <rate-select
                          v-model:value="ruleForm.TaskCategoryId"
                  ...
                  <el-col :span="14">
                    <div>
                      <el-form-item label="检查方式：" prop="MaintainceWay">
                        <el-select
                          v-model:value="ruleForm.MaintainceWay"
                          placeholder="请选择检查方式"
                          style="width: 100%"
                        >
                          <el-option
                            v-for="item in MaintainceWayOptions"
                            :key="item.value"
                            :label="item.label"
                            :value="item.value"
                          ></el-option>
                  ...
                  <el-col :span="14">
                    <div>
                      <el-form-item label="检查时间：" prop="PlanDealTime">
                        <el-date-picker
                          v-model:value="ruleForm.PlanDealTime"
                          type="date"
                          :clearable="false"
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <div>
                      <el-form-item>
                        <el-button
                          v-if="actionStatus.taskSave"
                          type="primary"
                          @click="submitForm('ruleForm', '任务保存')"
                          >保存</el-button
                        >
                      </el-form-item>
                    </div>
        ...
        <div v-if="statusInfo" id="cszywxcpfb">
          <el-collapse v-model:value="activeNames1" @change="handleChange">
                ...
                <el-tab-pane label="城市站运维现场检查评分表">
                  <table class="stats">
                    ...
                    <tr>
                      ...
                      <td>a) 站房环境是否清洁，是否符合检查要求</td>
                      <td>1</td>
                      <td>
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_1_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_1_Score != 1"
                          t="1621389729226"
                          class="icon"
                      ...
                      <td>
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_2"
                              :disabled="disable"
                              >站房环境脏，有明显灰尘,有明显异味；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_3"
                              :disabled="disable"
                              >站房物品摆放不整齐；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_4"
                              :disabled="disable"
                              >有明显异味；</el-checkbox
                            ></span
                          >
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_5"
                              :disabled="disable"
                              >仪器电源线路、气体线路不规整;</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_5_new"
                              :disabled="disable"
                              >有跟本监测站无关的设备及杂物，如废旧钢瓶气等；</el-checkbox
                            >
                          </span>
                        </p>
                      ...
                      <td>
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_1_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_9_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_9_Score != 2"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_11"
                              :disabled="disable"
                              >站房未配有温湿度计；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_10"
                              :disabled="disable"
                              >站房温度过高、过低（超过25±5℃）或湿度超过80%。（以现场检查单位经检定的温湿度计为准）；</el-checkbox
                            >
                          </span>
                        </p>
                        <!-- <p class=MsoNormal align=left style='margin-top:3.1pt;margin-right:0cm;margin-bottom:3.1pt;margin-left:10.5pt;text-align:left;line-height:115%;layout-grid-mode:char'>
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_9_Mark"
                          autocomplete="off"
                          :disabled="disable"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          ...
                          ><span
                            ...
                            >1</span
                          ><span style="font-family: 宋体; color: black"
                            >）要求，是否具备外接电源，其他基础设施是否满足监测要求</span
                          >
                        </p>
                      </td>
                      <td
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_14_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_14_Score != 2"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_15"
                              :disabled="disable"
                              >防水：站房有漏水；</el-checkbox
                            ></span
                          >
                        </p>
                        <!-- <p class=MsoNormal align=left style='margin-top:3.1pt;margin-right:0cm;margin-bottom:3.1pt;margin-left:10.5pt;text-align:left;line-height:115%;layout-grid-mode:char'>
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_17"
                              :disabled="disable"
                              >无防雷验收报告；</el-checkbox
                            ></span
                          >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_19"
                              :disabled="disable"
                              >灭火器不符合要求；（灭火器安装方式属于地方责任不应扣分,过期扣分）；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_20"
                              :disabled="disable"
                              >空调滤芯是否及时清理</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_21"
                              :disabled="disable"
                              >排气扇子故障；</el-checkbox
                            ></span
                          >
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_14_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                        ...
                        >
                          ...
                          ><span
                            style="
                              ...
                              letter-spacing: -0.5pt;
                            "
                            >以上的捕集空间；如果采样口一边靠近建筑物，采样口周围水平面应有</span
                          ><span
                            lang="EN-US"
                            style="
                              font-family: 'Times New Roman', 'serif';
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            >本项作为检查内容，现场检查如实记录问题，不作为评分项。</span
                          >
                        </p>
                      </td>
                      <td
                    ...
                    <tr>
                        ...
                        >
                          ...
                          ><span
                            style="
                              ...
                              letter-spacing: -0.3pt;
                            "
                            >）要求，即：对于总管，选用聚四氟乙烯或硼硅酸盐玻璃材料；对于采样支管，选用聚四氟乙烯材料</span
                          >
                        </p>
                      </td>
                      <td
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_26_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_26_Score != 1"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_27"
                              :disabled="disable"
                              >采样总管接口材质不满足要求；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_28"
                              :disabled="disable"
                              >采样支管材质不满足要求；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_351"
                              :disabled="disable"
                              >采样支管接口材质不满足要求；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_351_new"
                              :disabled="disable"
                              >采样支管材质不满足要求，1个月内未整改，若未按期完成；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_26_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black">
                            ）<span style="letter-spacing: -0.5pt"
                              >采样系统清洁程度：采样头、采样管道是否清洁，有无积灰、积水或障碍物，采样风机是否正常工作</span
                            >
                          </span>
                        </p>
                      </td>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_30_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_30_Score != 3"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_31"
                              :disabled="disable"
                              >颗粒物撞击板或切割头有明显积灰，颗粒物采样管未定期维护。</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_32"
                              :disabled="disable"
                              >气态采样总管不洁净；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_33"
                              :disabled="disable"
                              >气态采样支管不洁净；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_34"
                              :disabled="disable"
                              >采样风机未正常工作；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_33_new"
                              :disabled="disable"
                              >颗粒物采样头滤网是否完好、切割器密封圈是否完好；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_34_new"
                              :disabled="disable"
                              >颗粒物采样头滤网须须在1个月内整改完成，未按期完成；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_30_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <span
                            ...
                            >d</span
                          ><span style="font-family: 宋体; color: black"
                            >）气态污染物采样支管是否插入采样总管的中心，监测仪器与支管接头连接的管线长度是否小于</span
                          ><span
                            lang="EN-US"
                            style="
                              font-family: 'Times New Roman', 'serif';
                      ...
                      >
                        ...
                        >
                          <b>
                            <el-input
                              v-model:value="ruleFormZhiKong.E_rc_Jc_36_Score"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input>
                            <svg
                              v-if="ruleFormZhiKong.E_rc_Jc_36_Score != 1"
                              t="1621389729226"
                              class="icon"
                              viewBox="0 0 1024 1024"
                              version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_37"
                              :disabled="disable"
                              >采样支管未插入总管中心；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_38"
                              :disabled="disable"
                              >支管长度大于3m；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_36_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_40_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_40_Score != 2"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      <td
                        width="33%"
                        style="width: 33.76%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt气态污染物废气排在室内；其他 padding:0cm 5.4pt 0cm 5.4pt"
                      >
                        <p
                          class="MsoNormal"
                          align="left"
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_41"
                              :disabled="disable"
                              >气态污染物采样总管是否竖直安装；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_42"
                              :disabled="disable"
                              >采样口到站房顶部垂直距离是否大于
                              1m；（地方责任不应扣分，因运维更换、维护原因导致的扣分）；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_43"
                              :disabled="disable"
                              >内径是否为1.5cm～15cm，各支管接头间隔是否大于
                              8cm；（地方责任不应扣分，因运维更换、维护原因导致的扣分）；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_44"
                              :disabled="disable"
                              >空调直吹，不可改变的未采取措施避免影响；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_45"
                              :disabled="disable"
                              >采样管路连接不规范（如采样总管无固定或在连接处用胶布缠绕）；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_46"
                              :disabled="disable"
                              >气态污染物废气排在室内；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          ...
                          ><span
                            ...
                            >1-3</span
                          ><span style="font-family: 宋体; color: black"
                            >项作为检查内容，现场检查如实记录问题，不作为评分项，第</span
                          ><span
                            lang="EN-US"
                            style="
                              font-family: 'Times New Roman', 'serif';
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_40_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <span
                            ...
                            >f</span
                          ><span style="font-family: 宋体; color: black"
                            >）气态污染物采样总管是否有加热装置，加热温度是否控制在</span
                          ><span
                            lang="EN-US"
                            style="
                              font-family: 'Times New Roman', 'serif';
                          ...
                          ><span
                            ...
                            >50</span
                          ><span style="font-family: 宋体; color: black"
                            >℃。若采用不带加热系统的聚四氟乙烯或硼硅酸盐玻璃采样总管的，则其室内部分需加保温套</span
                          >
                        </p>
                      </td>
                      <td
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_48_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_48_Score != 3"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_49"
                              :disabled="disable"
                              >采样总管无加热系统或无温度显示装置；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_50"
                              :disabled="disable"
                              >加热系统故障，扣2分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_51_new"
                              :disabled="disable"
                              >温度显示装置故障，扣2分</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_51"
                              :disabled="disable"
                              >采样支管未加保温套，扣1分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_48_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_53_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_53_Score != 1"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_54"
                              :disabled="disable"
                              >仪器工作状态不正常，报警处理不及时扣1分</el-checkbox
                            >
                          </span>
                        </p>
                      </td>
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_53_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_56_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_56_Score != 2"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_57"
                              :disabled="disable"
                              >查看滤膜更换记录，仪器滤膜未及时更换（超过14天）；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_58"
                              :disabled="disable"
                              >仪器散热风扇工作不正常</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_58_new"
                              :disabled="disable"
                              >散热风扇过滤网缺失，未清理</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_56_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_61_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_61_Score != 2"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_62"
                              :disabled="disable"
                              >颗粒物采样管加热装置未正常工作，扣2分（加热装置故障）；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_63"
                              :disabled="disable"
                              >加热装置参数设置不符合要求，扣2分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_64"
                              :disabled="disable"
                              >颗粒物采样管是未加保温套，扣1分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_65"
                              :disabled="disable"
                              >采样管路空调直吹，扣1分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_61_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_67_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_67_Score != 2"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_68"
                              :disabled="disable"
                              >氧化剂、活性炭耗材和分子筛（若含分子筛则检查）未及时更换，扣2分。</el-checkbox
                            >
                          </span>
                        </p>
                      </td>
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_67_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <span
                            ...
                            >e</span
                          ><span style="font-family: 宋体; color: black">
                            ）采样<span class="GramE">泵相关</span
                            >耗材是否及时更换，空压机<span class="GramE"
                              >及时维护</span
                            >
                          </span>
                        </p>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_70_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_70_Score != 1"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_71"
                              :disabled="disable"
                              >采样泵相关耗材未定期更换；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_72"
                              :disabled="disable"
                              >空压机未及时维护；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_70_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_74_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_74_Score != 2"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_75"
                              :disabled="disable"
                              >未及时更换纸带；</el-checkbox
                            ></span
                          >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_401"
                              :disabled="disable"
                              >采样斑点分布不均匀，或不圆滑，或不完整，或拖尾，或穿孔或纸带装反等</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_401_new"
                              :disabled="disable"
                              >热电1405F仪器TEMO滤膜负载3L超过65%未更换</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_77_new"
                              :disabled="disable"
                              >热电1405F仪器TEMO滤膜负载1L超过25%未更换；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_77"
                              :disabled="disable"
                              >颗粒物采样平台脏；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_74_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        <p
                          class="MsoNormal"
                          align="left"
                          style="text-align: left; layout-grid-mode: char"
                        >
                          <span style="font-family: 宋体; color: black"
                            >动态校准仪质量流量控制器（MFC）单点流量测试（要
                            求相对误差≤±2%）:</span
                          >
                        </p>
                        <p
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_164"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input>
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_165"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_166"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          <span style="font-family: 宋体; color: black"
                            >流量：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_167"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >相对误差：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_169"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >:<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_171"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >:<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_172"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >:<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_173"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_79_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_79_Score != 5"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_80"
                              :disabled="disable"
                              >零气流量误差超出±2%，扣5分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <b>
                            <span lang="EN-US"
                              ><el-checkbox
                                v-model:value="ruleFormZhiKong.E_rc_Jc_81"
                                :disabled="disable"
                                >标气流量误差超出±2%的，扣 5 分；</el-checkbox
                              ></span
                            >
                          </b>
                        </p>
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_82"
                              :disabled="disable"
                              >多点MFC流量不合格，扣 5 分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_79_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr v-show="true">
                      ...
                      >
                        ...
                        >
                          ...
                          <span style="font-family: 宋体; color: black"
                            >显示流量：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_179"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >标准流量计测值：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_180"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >相对误差：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_181"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >输出浓度：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_182"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >仪器响应浓度：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_183"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_184"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >）：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_185"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >仪器零点响应浓度：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_186"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >（</span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >气密性检查<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_187"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_189"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_190"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_191"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >相对偏差<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_192"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >平均相对误差<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_193"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span
                            ...
                            style="
                              ...
                              color: black;
                            "
                            >:<!--<textarea id="E_rc_Jc_194" style="height:25px;width:80px;vertical-align:middle;overflow:hidden"></textarea>-->&nbsp;&nbsp;</span
                          >
                        </p>
                        <p
                          class="MsoNormal"
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_195"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_196"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_197"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_85_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_85_Score != 5"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      <td>
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_86"
                            :disabled="disable"
                            >采样流量误差超出±10%，扣5分;</el-checkbox
                          ></span
                        >
                        <br />
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_88"
                            :disabled="disable"
                            >跨度检查误差超出±5%，扣5分;</el-checkbox
                          ></span
                        >
                        <br />
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_89"
                            :disabled="disable"
                            >t90相应时间≥5min，扣1分；（6年及6年以上设备不扣分）；</el-checkbox
                          ></span
                        >
                        <br />
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_87"
                            :disabled="disable"
                            >仪器零点超出±5ppb，扣5分；；</el-checkbox
                          ></span
                        >
                        <br />
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_90"
                            :disabled="disable"
                            >按仪器说明书采样支管和仪器气路气密性检查不合格，扣2分；</el-checkbox
                          ></span
                        >
                        ...
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_91"
                            :disabled="disable"
                            >多点检查不合格，一次不合格扣5分;</el-checkbox
                          ></span
                        >
                        <br />
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_92"
                            :disabled="disable"
                            >精密度审核不合格，扣5分；</el-checkbox
                          ></span
                        >
                        <br />
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_93"
                            :disabled="disable"
                            >准确性审核不合格（可采用最近一次多点校准结果判定），扣5分</el-checkbox
                          ></span
                        >
                        <br />
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_92_new"
                            :disabled="disable"
                            >未按照要求打标识，扣1分；</el-checkbox
                          ></span
                        >
                        <br />
                        <span lang="EN-US"
                          ><el-checkbox
                            v-model:value="ruleFormZhiKong.E_rc_Jc_93_new"
                            :disabled="disable"
                            >主要参数不合格扣5分;</el-checkbox
                          ></span
                        >
                        <br />
                        <span style="font-family: 宋体; color: black">
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_85_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >显示流量：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_206"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >标准流量计测值：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_207"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >相对误差：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_208"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >输出浓度：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_209"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >仪器响应浓度：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_210"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >）：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_211"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >）：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_212"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >仪器零点响应浓度：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_213"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >（</span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >气密性检查<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_214"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_216"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_217"
                              autocomplete="off"
                              :disabled="disable"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_218"
                              autocomplete="off"
                              :disabled="disable"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >相对偏差<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_219"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><el-input
                            style="width: 100px"
                            v-model:value="ruleFormZhiKong.E_rc_Jc_220"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_215"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_95_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_95_Score != 5"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_96"
                              :disabled="disable"
                              >采样流量误差超出±10%的，扣 5 分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_96_new"
                              :disabled="disable"
                              >跨度检查误差超出±5%，扣5分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_99"
                              :disabled="disable"
                              >t90相应时间≥5min，扣1分；（6年及6年以上设备不扣分）；</el-checkbox
                            ></span
                          >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_97"
                              :disabled="disable"
                              >仪器零点超出±5ppb，扣 5 分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_100"
                              :disabled="disable"
                              >按仪器说明书采样支管和仪器气路气密性检查不合格，扣
                              2 分；</el-checkbox
                            >
                          </span>
                        </p>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_102"
                              :disabled="disable"
                              >多点校准不合格，一次不合格扣 5 分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_103"
                              >精密度审核不合格，扣 5 分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_104"
                              :disabled="disable"
                              >准确性审核不合格，扣5分（可采用最近一次多点校准结果判定）；</el-checkbox
                            ></span
                          >
                        </p>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_101"
                              :disabled="disable"
                              >钼炉平均转化效率小于 96
                              %，>102%,，扣5分;</el-checkbox
                            >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_98"
                              :disabled="disable"
                              >未按照要求打标识，扣1分；</el-checkbox
                            ></span
                          >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_98_new"
                              :disabled="disable"
                              >主要参数不合格扣5分；</el-checkbox
                            ></span
                          >
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_102_new"
                              :disabled="disable"
                              >未及时更换变色硅胶，扣2分；</el-checkbox
                            ></span
                          >
                        </p>
                      ...
                      <td
                        width="14%"
                        valign="top"
                        style="width:14.92%;border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;:3pt 5.4pt 0cm 5.4pt"
                      >
                        <el-input
                          type="textarea"
                          rows="20"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_95_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black">
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_235"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input> </span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_236"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_237"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >输出浓度：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_238"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_239"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_240"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_241"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_242"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >（</span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_243"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_244"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_245"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_246"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_247"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_248"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_249"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_250"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_251"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_252"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_253"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_106_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_106_Score != 5"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_107"
                              :disabled="disable"
                              >采样流量误差超出±10%的，扣5分；</el-checkbox
                            >
                          </span>
                        </p>
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_109"
                              :disabled="disable"
                              >跨度检查误差超出±5%的，扣5分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_110"
                              :disabled="disable"
                              >t90相应时间≥4min，扣1分；（6年及以上设备不扣分）；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_108"
                              :disabled="disable"
                              >仪器零点超出范围±0.4ppm，扣5分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_111"
                              :disabled="disable"
                              >按仪器说明书采样支管和仪器气路气密性检查不合格，扣2分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_112"
                              :disabled="disable"
                              >多点校准不合格，一次不合格扣 5 分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_113"
                              :disabled="disable"
                              >精密度审核不合格，扣 5 分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_114"
                              :disabled="disable"
                              >准确性审核不合格，扣5分；（可采用最近一次多点校准结果判定）；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_109_new"
                              :disabled="disable"
                              >未按照要求打标识，扣1分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span lang="EN-US"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_114_new"
                              :disabled="disable"
                              >主要参数不合格扣5分；</el-checkbox
                            ></span
                          >
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="15"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_106_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_262"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_263"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_264"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_265"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_266"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_267"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_268"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_269"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >（</span
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_270"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_272"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_273"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_274"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_275"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span
                            lang="EN-US"
                            tyle='font-family:"Times New Roman","serif";color:black'
                            >(</span
                          ><span style="font-family: 宋体; color: black"
                            >每年</span
                          ><span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_276"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_278"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_279"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_280"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_282"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >截距</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_283"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                            >相关系数</span
                          ...
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_284"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                      ...
                      <td
                        ...
                        style="
                          ...
                          border-bottom: solid windowtext 1pt;
                          border-right: solid windowtext 1pt;
                          padding: 0cm 5.4pt 0cm 12pt;
                        "
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_116_Score"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_116_Score != 5"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_117"
                              :disabled="disable"
                              >采样流量误差超出±10%，扣5分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_117_new"
                              :disabled="disable"
                              >跨度检查误差超出±5%，扣5分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_120"
                              :disabled="disable"
                              >t90相应时间≥5min，扣1分（6年及6年以上设备不扣分）；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_121_new"
                              :disabled="disable"
                              >仪器零点超出±5ppb，扣5分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_121"
                              :disabled="disable"
                              >按仪器说明书采样支管和仪器气路气密性检查不合格，扣1分。</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_123"
                              :disabled="disable"
                              >多点校准不合格，一次不合格扣 5 分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_124"
                              :disabled="disable"
                              >精密度审核不合格，扣 5 分；</el-checkbox
                            ></span
                          >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_125"
                              :disabled="disable"
                              >准确性审核不合格（可采用最近一次多点校准结果判定），扣5分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_122"
                              :disabled="disable"
                              >O3量值传递不合格，扣 5 分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_118"
                              :disabled="disable"
                              >未按照要求打标识，扣1分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span lang="EN-US">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_119"
                              :disabled="disable"
                              >主要参数不合格扣5分；</el-checkbox
                            ></span
                          >
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="15"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_116_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_294"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input> </span
                          ><span
                        ...
                        >
                          ...
                          >
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_295"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input> </span
                          ><span
                        ...
                        >
                          ...
                          >
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_296"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input> </span
                          ><span
                        ...
                        >
                          ...
                          >
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_297"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input>
                          </span>
                          ...
                          >
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_298"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input> </span
                          ><span style="font-family: 宋体; color: black"
                            ...
                            <span style="letter-spacing: -0.2pt">
                              <p>
                                3.其他仪器参数与说明书一致
                                <el-checkbox v-model:value="ruleFormZhiKong.hg"
                                  >合格</el-checkbox
                                >
                                <el-checkbox v-model:value="ruleFormZhiKong.bhg"
                                  >不合格</el-checkbox
                                >
                        ...
                        >
                          ...
                          ><span
                            style="
                              ...
                              letter-spacing: -0.2pt;
                            "
                            >校准<span class="GramE">膜检查</span>或</span
                          ><span
                            lang="EN-US"
                            style="
                              font-family: 'Times New Roman', 'serif';
                          ...
                          >
                            ：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_299"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input>
                          </span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black">
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_300"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input>
                          </span>
    ...
    color:black'>(</span><span style='font-family:宋体;color:black'>每年</span><span lang=EN-US style='font-family:"Times New Roman","serif";color:black'>
                      ...
                      >
                        ...
                        >
                          <el-input
                            v-model:value="ruleFormZhiKong.E_rc_Jc_127_Score"
                            :disabled="disable"
                            autocomplete="off"
                          ></el-input>
                          <svg
                            v-if="ruleFormZhiKong.E_rc_Jc_127_Score != 5"
                            t="1621389729226"
                            class="icon"
                            viewBox="0 0 1024 1024"
                            version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            <el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_128"
                              :disabled="disable"
                              >PM 10
                              实测流量与设计流量误差超出±5%，扣5分；；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_403"
                              :disabled="disable"
                              >PM
                              10显示流量与实测流量误差超出±5%，扣5分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_403_new"
                              :disabled="disable"
                              >PM
                              10显示流量与实测流量误差超出2%，扣2分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_129"
                              :disabled="disable"
                              >标准膜检查或查K值或K0值，K0
                              /K值，或浓度系数与原始值不符且不能提供相应校准依据，扣5分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_129_new"
                              :disabled="disable"
                              >其他参数不符合要求，扣2分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_130"
                              :disabled="disable"
                              >PM10校准膜检查或K0值检查结果不合格，扣5分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_131"
                              :disabled="disable"
                              >仪器检漏不合格；β射线法仪器示值大于1.0L/min，扣5分；振荡天平仪器主流量大于0.15L/min，旁路流量大于0.6L/min，扣5分</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_132"
                              :disabled="disable"
                              >未按时完成温、湿、压传感器检查和校准记录扣5分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_132_new"
                              :disabled="disable"
                              >未按照要求打标识，扣1分；</el-checkbox
                            >
                          </span>
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="15"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_127_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_308"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input> </span
                          ><span
                        ...
                        >
                          <span
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_309"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          <span
                            ...
                            <el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_310"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input></span
                          ><span
                        ...
                        >
                          ...
                          ><span
                            ...
                            >（标准回归斜率）：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_311"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                          ...
                          ><span
                            ...
                            >法：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_312"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        <p>
                          3.其他仪器参数与说明书一致
                          <el-checkbox v-model:value="ruleFormZhiKong.hg25"
                            >合格</el-checkbox
                          >
                          <el-checkbox v-model:value="ruleFormZhiKong.bhg25"
                            >不合格</el-checkbox
                          >
                        </p>
                        <p
                        ...
                        >
                          ...
                          ><span
                            ...
                            >：<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_313"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
                        ...
                        >
                          ...
                          ><span style="font-family: 宋体; color: black"
                            >气路检漏<el-input
                              style="width: 100px"
                              v-model:value="ruleFormZhiKong.E_rc_Jc_314"
                              :disabled="disable"
                              autocomplete="off"
                            ></el-input
                          ></span>
    ...
    color:black'>(</span><span style='font-family:宋体;color:black'>每年</span><span lang=EN-US style='font-family:"Times New Roman","serif";color:black'>)<el-input style="width:100px" v-model="ruleFormZhiKong.E_rc_Jc_315" autocomplete="off"></el-input></span>
                      ...
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_135_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_135_Score != 5"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_136"
                              :disabled="disable"
                              >PM2.5
                              实测流量与设计流量的误差超出±5%，扣5分；</el-checkbox
                            ></span
                          >
                        </p>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_140_new"
                              :disabled="disable"
                              >PM2.5显示流量与实测流量误差超出±5%，扣5分。</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_140"
                              :disabled="disable"
                              >M2.5显示流量与实测流量误差超出±2%，扣2分。</el-checkbox
                            ></span
                          >
                        </p>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_137"
                              :disabled="disable"
                              >标准膜检查或查K值或K0值，K0
                              /K值，或浓度系数与原始值不符且不能提供相应校准依据，扣5分；</el-checkbox
                            ></span
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_138"
                              :disabled="disable"
                              >其他参数不符合要求，扣 2 分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_137_new"
                              :disabled="disable"
                              >PM2.5校准膜检查或K0值检查结果不合格，扣5分；</el-checkbox
                            ></span
                          >
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_139"
                              :disabled="disable"
                              >仪器检漏不合格；β射线法仪器示值大于1.0L/min，扣5分；振荡天平仪器主流量大于0.15L/min，旁路流量大于0.6L/min，扣5分；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_501"
                              :disabled="disable"
                              >未按时完成温、湿、压传感器检查和校准记录扣5分；</el-checkbox
                            ></span
                          >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_501_new"
                              :disabled="disable"
                              >未按照要求打标识，扣1分；</el-checkbox
                            ></span
                          >
                        ...
                        <p
                          class="MsoNormal"
                          align="left"
                          style="margin-top: 1.55pt; margin-right: 0cm;margin-bottom: 1.55pt; margin-left: 10.5pt; text-align: left; line-height: 115%>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           layout-grid-mode: char"
                        >
                          <span style="font-family: 宋体; color: black">
                            备注：扣分上限为单项分值。
                          </span>
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="15"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_135_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        <p>
                          流量计有效期限：<input
                            v-model="ruleFormZhiKong.E_rc_Jc_1000"
                            type="text"
                            :disabled="disable"
                            class="td_input"
                            id="E_rc_Jc_1000"
                        ...
                        <p>
                          温湿度计有效期限：<input
                            v-model="ruleFormZhiKong.E_rc_Jc_1001"
                            type="text"
                            :disabled="disable"
                            class="td_input"
                            id="E_rc_Jc_1001"
                        ...
                        <p>
                          大气压计有效期限：<input
                            v-model="ruleFormZhiKong.E_rc_Jc_1002"
                            type="text"
                            :disabled="disable"
                            class="td_input"
                            id="E_rc_Jc_1002"
                        ...
                        <p>
                          钢瓶气（标气）NO有效期限：<input
                            v-model="ruleFormZhiKong.E_rc_Jc_1003"
                            type="text"
                            :disabled="disable"
                            class="td_input"
                            id="E_rc_Jc_1003"
                        ...
                        <p>
                          钢瓶气（标气）CO有效期限：<input
                            v-model="ruleFormZhiKong.E_rc_Jc_1004"
                            type="text"
                            :disabled="disable"
                            class="td_input"
                            id="E_rc_Jc_1004"
                        ...
                        <p>
                          钢瓶气（标气）SO2有效期限：<input
                            v-model="ruleFormZhiKong.E_rc_Jc_1005"
                            type="text"
                            :disabled="disable"
                            class="td_input"
                            id="E_rc_Jc_1005"
                      ...
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_142_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_142_Score != 5"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_143"
                              :disabled="disable"
                              >流量计超出有效期</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_144"
                              :disabled="disable"
                              >温湿度计超出有效期；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_145"
                              :disabled="disable"
                              >大气压计超出有效期；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_146"
                              :disabled="disable"
                              >钢瓶气无标签；</el-checkbox
                            >
                          </span>
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_147"
                              :disabled="disable"
                              >钢瓶气过期；</el-checkbox
                            >
                          </span>
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="15"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_142_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >能否正常采集数据并上报城市站、省站、总站并发布数据</span
                          >
                        </p>
                      </td>
                      <td
                      ...
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_149_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_149_Score != 3"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_353"
                              :disabled="disable"
                              >监测仪器时间与数采仪时间不同步，监测仪器或数采仪时间未校准，任一功能不满足，扣3分；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            ><el-checkbox
                              v-model:value="ruleFormZhiKong.E_rc_Jc_352"
                              :disabled="disable"
                              >不能正常采集数据并上报城市站、省站、总站，且未报备的（此项不扣分）；</el-checkbox
                            >
                          </span>
                        </p>
                        <p
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            任<span class="GramE">一</span>功能不满足，扣 </span
                          ><span
                            lang="EN-US"
                            style="
                              font-family: 'Times New Roman', 'serif';
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="15"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_149_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          ...
                          ><b>
                            <span style="font-family: 宋体; color: black"
                              >运<span class="GramE">维人员</span>要求</span
                            >
                          </b>
                        </p>
                        <p
                      ...
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_151_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_151_Score != 2"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="15"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_151_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_153_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_153_Score != 5"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_153_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          ...
                          ><b>
                            <span style="font-family: 宋体; color: black"
                              >运<span class="GramE">维工作</span>完成情况</span
                            >
                          </b>
                        </p>
                        <p
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black">
                            是否<span class="GramE">按照运维要求</span
                            >完成当月运<span class="GramE">维工作</span>
                          </span>
                        </p>
                      </td>
                      <td
                      ...
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_155_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_155_Score != 20"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >对照运维工作规定规范和合同要求检查每日、每周、每月、每季度、每年任务执行情况。</span
                          >
                        </p>
                        <p
                          class="MsoNormal"
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_155_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_157_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_157_Score != 5"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_157_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        <el-input
                          v-model:value="ruleFormZhiKong.E_rc_Jc_1006_Score"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                        <svg
                          v-if="ruleFormZhiKong.E_rc_Jc_1006_Score != 0"
                          t="1621389729226"
                          class="icon"
                          viewBox="0 0 1024 1024"
                          version="1.1"
                      ...
                      >
                        ...
                        >
                          <span style="font-family: 宋体; color: black"
                            >到现场检查通知后，运维人员不得再进站维修校准设备，若遇到数据异常，需与检查方沟通后才能进站，否则扣5分。</span
                          ><span
                            lang="EN-US"
                            style="
                              font-family: 'Times New Roman', 'serif';
                      ...
                      >
                        <el-input
                          type="textarea"
                          rows="8"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_1006_Mark"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      ...
                      <td colspan="1" style="text-align: left">
                        <p>
                          13.采样总管不符合要求（因采样总管问题，采样支管无法插入到总管中心则不扣分）；
                        </p>
                    ...
                    <tr>
                      ...
                      <td colspan="1" style="text-align: left">
                        <p>
                          16.
                          PM10和PM2.5颗粒物采样管过高（标准为采样管长度不超过5米）；
                        </p>
                        <p>17. PM10、PM2.5设备与采样头、切割器不匹配；</p>
                        <p>18. 颗粒物采样头、切割器有划痕；</p>
                        <p>19. 无三脚架；</p>
                        <p>
                          20. 站房工控机可正常传输数据，但无法直接连接外网；
                        </p>
                      </td>
                      <td></td>
                    </tr>
                      ...
                      <td colspan="6">
                        ...
                        >
                          <tr>
                            <td>
                              &nbsp;S02<el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_so2Type"
                                :disabled="disable"
                                autocomplete="off"
                              ></el-input>
                            </td>
                            <td>
                              &nbsp;N0x<el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_noXType"
                                :disabled="disable"
                                autocomplete="off"
                              ></el-input>
                            </td>
                            <td>
                              &nbsp;&nbsp;CO<el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_coType"
                                :disabled="disable"
                                autocomplete="off"
                              ></el-input>
                            </td>
                      ...
                      <td colspan="6">
                        ...
                        >
                          <tr>
                            <td>
                              &nbsp;O3&nbsp;&nbsp;<el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_o3Type"
                                :disabled="disable"
                                autocomplete="off"
                              ></el-input>
                            </td>
                            <td>
                              PM10<el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_pm10Type"
                                :disabled="disable"
                                autocomplete="off"
                              ></el-input>
                            </td>
                            <td>
                              PM25<el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_pm25Type"
                                :disabled="disable"
                                autocomplete="off"
                              ></el-input>
                            </td>
                      ...
                      <td colspan="6">
                        ...
                        >
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1100"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1101"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1102"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1103"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1104"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1105"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1106"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1107"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1108"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1109"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1110"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1111"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1112"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1113"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1114"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1115"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1116"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1117"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1118"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1119"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1120"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1121"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1122"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1123"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1124"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1125"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1126"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1127"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1128"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1129"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1130"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1131"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1132"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1133"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1134"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1135"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1136"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1137"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1138"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1139"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1140"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1141"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1142"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1143"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1144"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1145"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1146"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1147"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1148"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1149"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1150"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1151"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1152"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1153"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1154"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1155"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                      ...
                      <td colspan="6">
                        ...
                        >
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1156"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1157"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1158"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1159"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1160"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1161"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1162"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1163"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1164"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1165"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1166"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1167"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1168"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1169"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1170"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1171"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1172"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1173"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1174"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1175"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1176"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1177"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1178"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                            <td>
                              <el-input
                                v-model:value="ruleFormZhiKong.E_rc_Jc_1179"
                                autocomplete="off"
                                :disabled="disable"
                              ></el-input>
                            </td>
                          ...
                          <tr>
                            ...
                            <td colspan="8">
                              <textarea
                                v-model="ruleFormZhiKong.E_rc_Jc_1180"
                                :disabled="disable"
                                style="width: 90%"
                                id="Remark"
                              ></textarea>
                    ...
                    <tr>
                      ...
                      <td colspan="5">
                        <el-input
                          type="textarea"
                          rows="15"
                          v-model:value="ruleFormZhiKong.E_rc_Jc_410"
                          :disabled="disable"
                          autocomplete="off"
                        ></el-input>
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        检查人员：
                        <el-input
                          v-model:value="ruleForm.DealerName"
                          autocomplete="off"
                          :disabled="disable"
                        ></el-input>
                      </td>
                      <td colspan="2">
                        确认人员:<el-input
                          v-model:value="ruleForm.ReviewerName"
                          autocomplete="off"
                          :disabled="disable"
                        ></el-input>
                      </td>
                      <td colspan="4">
                        <span v-if="showStatus < 4">检查</span
                        ><span v-else>复查</span>日期:
                        <el-date-picker
                          v-model:value="ruleFormZhiKong.CreateRptTime"
                          type="date"
                          :clearable="false"
                          :disabled="disable"
                          value-format="yyyy-MM-dd"
                    ...
                    <tr>
                      ...
                      <td colspan="5">
                        ...
                        <el-dialog v-model:visible="dialogVisiblePic">
                    ...
                    <tr>
                      ...
                      <td colspan="5">
                        ...
                        <div class="image">
                          <span
                            v-for="(f, index) in ywzgfileListAdd"
                            :key="index"
                          >
                            <el-image
                              style="margin: 2px; width: 100px; height: 100px"
                              :src="f.fileURL"
                              :preview-src-list="ywzgfileListAdd"
                            ></el-image>
                            <i
                              style="
                                position: relative;
                              ...
                              @click="deleteImg(f.fileGUID, f.fileURL)"
                            ></i>
                          </span>
                        </div>
                      </td>
                  ...
                  <div id="btn" style="margin: 20px 0; text-align: center">
                    <el-link
                      type="primary"
                      style="line-height: 20px; float: left; margin: 15px 25px"
                      @click="fileManage"
                      >点击进入附件下载页面</el-link
                    >
                    <el-button
                      v-if="actionStatus.formSave"
                      type="primary"
                      @click="saveReport"
                      >保存</el-button
                    >
                ...
                <el-tab-pane label="城市站运维现场检查特殊问题">
                  <div class="tools">
                    ...
                    <el-button
                      size="small"
                      v-if="actionStatus.modifyFinish"
                      class="el-button--iconButton"
                      icon="el-icon-plus"
                      style="text-overflow: initial"
                    ...
                    <el-button
                      size="small"
                      v-if="actionStatus.reviewModify"
                      class="el-button--iconButton"
                      icon="el-icon-plus"
                      style="text-overflow: initial"
                      @click="handleReview"
                ...
                <el-col :span="24">
                  <div>
                    <el-form-item label="问题分类：" prop="SpecialProblemType">
                      <el-select
                        v-model:value="ruleForm1.SpecialProblemType"
                        placeholder="请选择问题分类"
                        style="width: 100%"
                      >
                        <el-option
                          v-for="item in SpecialProblemOptions"
                          :key="item.value"
                          :label="item.label"
                          :value="item.value"
                        ></el-option>
                ...
                <el-col :span="24">
                  <div>
                    <el-form-item label="责任方：" prop="ResponsibleParty">
                      <el-select
                        v-model:value="ruleForm1.ResponsibleParty"
                        placeholder="请选择责任方"
                        style="width: 100%"
                      >
                        <el-option
                          v-for="item in ResponsiblePartyOptions"
                          :key="item.value"
                          :label="item.label"
                          :value="item.value"
                        ></el-option>
                  ...
                  <div>
                    <el-form-item label="整改问题：" prop="InspectProblem">
                      <el-input
                        type="textarea"
                        rows="5"
                        v-model:value="ruleForm1.InspectProblem"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  </div>
                ...
                <el-col :span="24">
                  <div>
                    <el-form-item label="整改时间：" prop="ModifyDateTime">
                      <el-date-picker
                        v-model:value="ruleForm1.ModifyDateTime"
                        type="date"
                        :clearable="false"
                        value-format="yyyy-MM-dd"
                        placeholder="请选择日期"
        ...
        <div>
          <el-dialog
            title="第四方复核确认"
            v-model:visible="fourthJudgeFormDialogVisible"
            width="30%"
          >
            <el-form
                ...
                <el-col :span="12">
                  <div>
                    <el-form-item label="复核结果：" prop="Result">
                      <el-radio-group v-model:value="fourthJudgeForm.Result">
                        <el-radio label="1">通过</el-radio>
                        <el-radio label="2">不通过</el-radio>
                      </el-radio-group>
                    </el-form-item>
                ...
                <el-col :span="24">
                  <div>
                    <el-form-item label="相关意见：" prop="Reason">
                      <el-input
                        type="textarea"
                        v-model:value="fourthJudgeForm.Reason"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  </div>
                ...
                <el-col :span="10">
                  <div>
                    <el-form-item>
                      <el-button
                        type="primary"
                        @click="submitForm('fourthJudgeForm', '第四方复核')"
                        >确定</el-button
                      >
                    </el-form-item>
                  </div>
        ...
        <div>
          <el-dialog
            title="问题整改描述"
            v-model:visible="modifyProblemDialogVisible"
            width="30%"
          >
            <el-form
                  ...
                  <div>
                    <el-form-item label="内容：" prop="ModifyProblem">
                      <el-input
                        type="textarea"
                        rows="5"
                        v-model:value="modifyProblemForm.ModifyProblem"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      <rateJainChaUpload
                        :limit="10"
                        :Ismultiple="true"
                        :BusinessId="modifyProblemForm.TaskChildNo"
                        :BusinessType="39"
                ...
                <el-col :span="10">
                  <div>
                    <el-form-item>
                      <el-button
                        type="primary"
                        @click="submitForm('modifyProblem', '对问题进行整改')"
                        >保存</el-button
                      >
                    </el-form-item>
                  </div>
        ...
        <div>
          <el-dialog
            title="现场复查确认"
            v-model:visible="reviewJudgeFormDialogVisible"
            width="35%"
          >
            <el-form
                ...
                <el-col :span="12">
                  <div>
                    ...
                    <el-form-item label="复查结果：" prop="Status">
                      <el-radio-group v-model:value="reviewJudgeForm.Status">
                ...
                <el-col :span="24">
                  <div>
                    <el-form-item label="复查意见：" prop="ModifyProblem">
                      <el-input
                        type="textarea"
                        v-model:value="reviewJudgeForm.ModifyProblem"
                        autocomplete="off"
                      ></el-input>
                    </el-form-item>
                  </div>
                ...
                <el-col :span="10">
                  <div>
                    <el-form-item>
                      <el-button
                        type="primary"
                        @click="submitForm('reviewJudgeForm', '现场复查')"
                        >保存</el-button
                      >
                    </el-form-item>
                  </div>
        ...
        <div>
          <el-dialog
            title="附件管理"
            v-model:visible="fileInfoManageVisible"
            width="50%"
            height="30%"
          >
            <rate-table
        ...
        <div>
          <el-dialog
            title="整改问题历史记录"
            v-model:visible="problemHistoryVisible"
            width="50%"
            height="30%"
          >
            <rate-table
              :list="list_problemHistory"
...
import rateUpload from '../common/rateUpload2' //引入rateUpload组件
...
export default {
  ...
  data() {
    return {
      ...
      rules1: {
        InspectProblem: [
          { required: true, message: '请填写检查问题描述', trigger: 'blur' },
        ],
        ModifyDateTime: [
        ...
        ResponsibleParty: [
          { required: true, message: '请选择责任方', trigger: 'blur' },
        ],
      },
      ...
      columns_Maintentance: [
        ...
        {
          prop: 'responsiblePartyName',
          label: '责任方',
          align: 'center',
          isShow: true,
        },
        {
          prop: 'show_ModifyDateTime',
          label: '计划整改时间（检查人员填写）',
          align: 'center',
          isShow: true,
        },
      ...
      columns_problemHistory: [
        ...
        {
          prop: 'show_ActualDealTime',
          label: '处理时间',
          align: 'center',
          isShow: true,
        },
        {
          prop: 'show_ChineseStatus',
          label: '状态',
          align: 'center',
          isShow: true,
        },
  ...
  methods: {
    ...
    getSpecialProblemId(id) {
      ...
      this.$http({
        method: 'GET',
        url:
          this.api + '/api/FourthInspectionTask/GetSpecialProblemById?id=' + id,
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    getList_file() {
      ...
      this.$http({
        ...
        url:
          self.api +
          '/api/Common/GetFileByTaskId?pageSize=' +
          self.page_file.pageSize +
          '&pageIndex=' +
          self.page_file.pageNo +
          '&id=' +
          self.ruleForm.TaskNo,
      })
        .then((res) => {
          if (res.status == 200) {
      ...
      if (imgUrlArr.length > 0) {
        imgUrlArr.forEach((item) => {
          this.$http({
            ...
            url:
              self.api +
              '/api/Common/GetFlieStream?partialPath=' +
              item.fileURL,
          })
            .then((res) => {
    ...
    getList_problemHistory(taskChildNo) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/FourthInspectionTask/GetProblemHistoryRecord?pageSize=' +
          self.page_problemHistory.pageSize +
          '&pageIndex=' +
          self.page_problemHistory.pageNo +
          '&taskChildNo=' +
          taskChildNo,
      })
        .then((res) => {
    ...
    getNowTime() {
      ...
      this.ruleFormZhiKong['CreateRptTime'] = defaultDate
    },
    ...
    handleReview() {
      ...
      //新增
      self.reviewJudgeForm.TaskChildNo =
        this.handleSelection_Maintentance[0].taskChildNo
      self.reviewJudgeForm.InspectProblem =
        this.handleSelection_Maintentance[0].inspectProblem
      self.reviewJudgeForm.ModifyDateTime =
        this.handleSelection_Maintentance[0].modifyDateTime
      self.reviewJudgeForm.SpecialProblemType =
        this.handleSelection_Maintentance[0].specialProblemType
      self.reviewJudgeForm.ResponsibleParty =
        this.handleSelection_Maintentance[0].responsibleParty
    },
    ...
    handleDealProblem() {
      ...
      debugger
      //新增  特殊问题相关的变量
      self.modifyProblemForm.TaskChildNo =
        this.handleSelection_Maintentance[0].taskChildNo
      self.modifyProblemForm.InspectProblem =
        this.handleSelection_Maintentance[0].inspectProblem
      self.modifyProblemForm.ModifyDateTime =
        this.handleSelection_Maintentance[0].modifyDateTime
      self.modifyProblemForm.SpecialProblemType =
        this.handleSelection_Maintentance[0].specialProblemType
      self.modifyProblemForm.ResponsibleParty =
        this.handleSelection_Maintentance[0].responsibleParty
    },
    ...
    handlemultipl(ids) {
      ...
      this.$http({
        method: 'GET',
        url:
          this.api + '/api/FourthInspectionTask/SpecialProblemDelete?id=' + ids,
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    getCurrentPage_problemHistory(val) {
      //table组件发射的方法  用于改变当前所在页码
    ...
    handleReturn() {
      ...
      if (self.fromTab == 'operate') {
        $emit(this, 'closeCurrentPage', '第四方检查任务窗口') //调用closeCurrentPage方法注意；两点1：第二个参数必须是string，2：长度必须大于等于4
        $emit(this, 'jump', {
          param: '第四方任务整改',
    ...
    getList_Maintentance() {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/FourthInspectionTask/GetSpecialProblemByPage?pageSize=' +
      ...
      switch (actionName) {
          ...
          this.$refs[formName].validate((valid) => {
            if (valid) {
              ...
              this.$http({
                ...
                method: 'post',
                url:
                  self.api + '/api/FourthInspectionTask/ShiStationTaskSubmit',
        ...
        case '检查结果提交':
          ...
          this.$http({
            ...
            url:
              self.api +
              '/api/FourthInspectionTask/FirstTrial?taskNo=' +
              self.ruleForm.TaskNo,
          })
            .then((res) => {
              if (res.status == 200) {
    ...
    getToFirst(planNo) {
      ...
      this.$http({
        method: 'GET',
        url:
          this.api + '/api/FourthInspectionTask/GetFourthTaskById?id=' + planNo,
      })
        .then((res) => {
          if (res.status == 200) {
            if (res.data.data != null) {
              ...
              self.ruleForm.MaintainceWay =
                res.data.data.maintainceWay.toString()
              self.ruleForm.PlanDealTime = res.data.data.planDealTime
              self.ruleForm.Status = res.data.data.status
              self.ruleForm.TaskCategoryId =
                res.data.data.taskCategoryId.toString()
            }
        ...
        .then(function () {
          self
            .$http({
              ...
              url:
                self.api +
                '/api/Upload/DeleteByFileGUID?FileGUID=' +
                fileGUID +
                '&FileURL=' +
                fileURL,
            })
    ...
    getTaskScore(taskNo) {
      ...
      this.$http({
        method: 'GET',
        url:
          this.api + '/api/FourthInspectionTask/GetJcRptById?taskNo=' + taskNo,
      })
        .then((res) => {
          if (res.status == 200) {
            //处理数据
    ...
    setActionStatus() {
      ...
      this.actionStatus.aduit =
        this.ruleForm.Status == 2 || this.ruleForm.Status == 3 ? true : false
      this.actionStatus.add =
        this.ruleForm.Status >= 2 && this.ruleForm.Status < 6 ? true : false
