    ...
    <el-container>
        ...
        <div class="fly-panel detail-box">
          ...
          <div class="fly-detail-info">
            ...
            <span class="fly-list-nums">
              ...
              <a href="#comment" @click="show_Comment = !show_Comment"
                ><i class="el-icon-chat-dot-round" title="回复"></i
              ></a>
            </span>
          </div>
      ...
      <el-main>
        ...
        <div
          ...
          v-for="(item, index) in list.huifu"
          :key="index"
        >
          ...
          <div class="fly-detail-info">
            ...
            <span class="fly-list-nums">
              ...
              <a v-if="list.stateName == '处理中'" @click="useCheck(item.id)"
                ><i class="el-icon-s-check" title="采纳"></i
              ></a>
            </span>
          </div>
          <div class="detail-body layui-text photos">
              ...
              <el-col :span="20">
                <el-form-item label="" prop="Content">
                  <el-input
                    type="textarea"
                    :rows="6"
                    v-model:value="ruleForm.ReplyContent"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </el-col>
