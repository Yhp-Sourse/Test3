<template>
  <div id="v_deviceSparePartInfo">
    ...
    <div>
      <el-dialog title="备品备件" v-model:visible="dialogVisible" width="60%">
        <el-form
          :model="ruleForm"
          status-icon
          :rules="rules"
            ...
            <el-col :span="12">
              <div>
                <el-form-item label="出库日期:" prop="ProcurementDateEnd">
                  <el-date-picker
                    v-model:value="ruleForm.ProcurementDateEnd"
                    type="date"
                    placeholder="选择日期"
                  ></el-date-picker>
                </el-form-item>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="是否备案:" prop="IsKeepRecord">
                <el-radio-group v-model:value="ruleForm.IsKeepRecord">
      ...
      >
        ...
        >
          <el-form-item label="审核结果:" prop="Results">
            <el-radio-group v-model:value="check.Results">
      ...
      <el-dialog
        title="备品备件是否使用"
        v-model:visible="dialogVisibleisUsed"
        width="50%"
      >
        <el-form
          :model="used"
        ...
        >
          <el-form-item label="是否使用:" prop="Results">
            <el-radio-group v-model:value="used.Results">
          ...
          <el-form-item>
            <el-button type="primary" @click="saveForm2('used')"
              >保存</el-button
            >
          </el-form-item>
        </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        DeviceCode: [
          { required: false, message: '请输入子站编码', trigger: 'blur' },
        ],
        FileName: [
          { required: true, message: '请上传检验单', trigger: 'change' },
        ],
      },
      queryparam: {
        QName: '',
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$http({
            ...
            method: 'post',
            url:
              self.api + '/api/Yw_DeviceSparePartInfo/DeviceSparePartInfo_Used',
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$http({
            ...
            method: 'post',
            url:
              self.api + '/api/Yw_DeviceSparePartInfo/DeviceSparePartInfo_Save',
