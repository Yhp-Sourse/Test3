  ...
  <el-tabs type="border-card">
    <el-tab-pane>
      <template v-slot:label>
        <span
          >备机信息<i @click="XSJToggel" :class="XiaoSanJiaoStyle"></i
        ></span>
      </template>
      <el-container
        v-if="isChage"
        style="height: calc(100vh - 145px); border: 1px solid #eee"
      >
          ...
          <el-header>
            <div class="search">
              <el-form :inline="true" class="demo-form-inline" size="mini">
                <el-form-item label="变更类型：">
                  <rate-select
                    v-model:value="rateCTSelect.model"
                ...
                <el-form-item label="未下架30天：">
                  <el-select
                    v-model:value="queryparam.WXJ30Day"
                    clearable
                    placeholder="全部"
                  >
                    <el-option
                ...
                <el-form-item label="仪器状态：">
                  <rate-select
                    v-model:value="rateDevSelect.model"
                ...
                <el-form-item class="btn">
                  <el-button
                    size="small"
                    v-has="'DevUseRecord_handleSearch'"
                    type="primary"
                    icon="el-icon-search"
                    @click="getList()"
                    >查询</el-button
            ...
            <div class="tools">
              ...
              <el-button
                ...
                icon="el-icon-delete"
                style="text-overflow: initial"
                v-has="'DevUseRecord_handleMultiplDel'"
      ...
      <el-dialog
        title="设备使用"
        v-model:visible="dialogDevUseRecordeVisible"
        width="50%"
      >
        <el-form
          :model="ruleForm"
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="参数：" prop="Param">
                <rate-select
                  v-model:value="rateYSBSelect.model"
            ...
            <el-col :span="12">
              <el-form-item label="设备型号：" prop="OriginDType">
                <el-input
                  v-model:value="ruleForm.OriginDType"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row v-if="ruleForm.ChangeType != '7'">
            <el-col :span="6">
              <el-form-item label="备机库：" prop="PartCity">
                <rate-select
                  v-model:value="rateBJKSelect.model"
            ...
            <el-col :span="6">
              <el-form-item label="设备厂家：" prop="NewDF">
                <rate-select
                  v-model:value="rateFacSelect.model"
            ...
            <el-col :span="6">
              <el-form-item label="设备名称" prop="NewDName">
                <rate-select
                  v-model:value="rateSPSelect.model"
            ...
            <el-col :span="6">
              <el-form-item label="设备型号：" prop="NewDType">
                <el-input
                  v-model:value="ruleForm.NewDType"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row v-if="ruleForm.ChangeType == '7'">
            ...
            <el-col :span="12">
              <el-form-item label="设备型号：" prop="NewDName">
                <el-input
                  v-model:value="ruleForm.NewDName"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="更换日期" prop="ChangeTime">
                <el-date-picker
                  v-model:value="ruleForm.ChangeTime"
                  type="date"
                  placeholder="选择日期"
                  format="yyyy 年 MM 月 dd 日"
                  value-format="yyyy-MM-dd"
            ...
            <el-col :span="12">
              <el-form-item label="新设备编号" prop="NewdevId">
                <el-input
                  v-model:value="ruleForm.NewdevId"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
              ...
              <div>
                <el-form-item label="备注：" prop="ChangeReason">
                  <el-input
                    type="textarea"
                    :rows="9"
                    v-model:value="ruleForm.ChangeReason"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </div>
      ...
      <el-dialog title="延期使用申请" v-model:visible="delayDialog" width="50%">
        <el-form
          :model="delayruleForm"
          status-icon
          :rules="rules"
            ...
            <el-col :span="12">
              ...
              >
                <rateUpload
                  ...
                  :BusinessId="ruleForm.Id"
                  :BusinessType="5"
                  @uploadSuccess="uploadDelaySuccess"
                ></rateUpload>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="延期备注：" prop="DelayRemark">
                <el-input
                  type="textarea"
                  :rows="9"
                  v-model:value="delayruleForm.DelayRemark"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
    ...
    <el-tab-pane v-show="false" label="维修记录">
            ...
            <div class="search">
              <el-form :inline="true" class="demo-form-inline" size="mini">
                <el-form-item label="名称：">
                  <el-input
                    v-model:value="queryparam_Repair.Main_Model"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
                <el-form-item
                ...
                >
                  <el-select
                    v-model:value="queryparam_Repair.Main_Param"
                    placeholder="请选择"
                    style="width: 100%"
                  >
                    <el-option
      ...
      <el-dialog
        title="设备维修记录"
        v-model:visible="dialog_Repair"
        width="50%"
      >
        <el-form
          :model="ruleForm_Repair"
          status-icon
          :rules="rules_Repair"
          ref="ruleForm_Repair"
          label-width="100px"
        ...
        >
          <el-row>
            <el-col :span="12">
              <el-form-item v-show="false" label="" prop="Id">
                <el-input
                  v-model:value="ruleForm_Repair.Id"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
              <el-form-item label="维修类型" prop="RepairType">
                <rate-select
                  v-model:value="rateWXSelect.model"
            ...
            <el-col :span="12">
              <el-form-item label="站点名称：" prop="SStation">
                <rateCascader
                  :selectOption="ruleForm_Repair.SStation"
                  @selectOptionEvent="selectOptionEvent_Repair"
                ></rateCascader>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="设备型号：" prop="Main_Model">
                <el-input
                  v-model:value="ruleForm_Repair.Main_Model"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="设备厂家" prop="Back_FactId">
                <el-select
                  v-model:value="ruleForm_Repair.Back_FactId"
                  clearable
                  placeholder="请选择"
                >
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="设备信息" prop="Back_DType">
                <el-select
                  v-model:value="ruleForm_Repair.Back_DType"
                  clearable
                  placeholder="请选择"
                >
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="故障时间：" prop="FailureTime">
                <el-date-picker
                  v-model:value="ruleForm_Repair.FailureTime"
                  type="datetime"
                  placeholder="选择开始时间"
                  align="right"
                >
            ...
            <el-col :span="12">
              <el-form-item label="故障时间：" prop="FailureTime">
                <el-date-picker
                  v-model:value="ruleForm_Repair.FailureEndTime"
                  type="datetime"
                  placeholder="选择结束时间"
                  align="right"
                >
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="故障现象：" prop="FailurePhenomenon">
                <el-input
                  v-model:value="ruleForm_Repair.FailurePhenomenon"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="处理方法：" prop="Resolve">
                <el-input
                  v-model:value="ruleForm_Repair.Resolve"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="24">
              <div>
                <el-form-item label="维修人员:" prop="LYR">
                  <el-input
                    v-model:value="ruleForm_Repair.WXR"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </div>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="维修配件：" prop="Parts">
                <el-input
                  v-model:value="ruleForm_Repair.Parts"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="维修费用(元):" prop="Cost">
                <el-input
                  v-model:value="ruleForm_Repair.Cost"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="故障原因：" prop="CauseFailure">
                <el-input
                  v-model:value="ruleForm_Repair.CauseFailure"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
              ...
              <div>
                <el-form-item v-show="true" label="附件：" prop="Id">
                  <rateUpload
                    ...
                    :BusinessId="ruleForm.Id"
                    :BusinessType="6"
                    @uploadSuccess="uploadSuccess_Repair"
                  ></rateUpload>
                </el-form-item>
              </div>
            </el-col>
            ...
            <el-col :span="6">
              <div>
                <el-form-item>
                  <el-button
                    type="primary"
                    @click="submitForm_Repair('ruleForm_Repair')"
                    >提交</el-button
                  >
                </el-form-item>
              </div>
    ...
    <el-tab-pane label="报废记录">
          ...
          <el-header>
            <div class="search">
              <el-form :inline="true" class="demo-form-inline" size="mini">
                <el-form-item label="名称：">
                  <el-input
                    v-model:value="queryparam_Scrap.DeviceName"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
                <el-form-item class="btn">
      ...
      <el-dialog
        title="设备报废记录"
        v-model:visible="dialog_Scrap"
        width="50%"
      >
        <el-form
          :model="ruleForm_Scrap"
          status-icon
          :rules="rules_Scrap"
          ref="ruleForm_Scrap"
          label-width="100px"
        ...
        >
          <el-row>
            <el-col :span="24">
              <el-form-item v-show="false" label="" prop="Id">
                <el-input
                  v-model:value="ruleForm_Scrap.Id"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
              <el-form-item label="站点名称：" prop="SStation">
                <rateCascader
                  :selectOption="ruleForm_Scrap.SStation"
                  @selectOptionEvent="selectOptionEvent_Scrap"
                ></rateCascader>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="设备名称：" prop="DeviceName">
                <el-input
                  v-model:value="ruleForm_Scrap.DeviceName"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="设备型号：" prop="DeviceModel">
                <el-input
                  v-model:value="ruleForm_Scrap.DeviceModel"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="24">
              <div>
                <el-form-item label="维修人员:" prop="LYR">
                  <el-input
                    v-model:value="ruleForm_Scrap.WXR"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </div>
            ...
            <el-col :span="6">
              <div>
                <el-form-item>
                  <el-button
                    type="primary"
                    @click="submitForm_Scrap('ruleForm_Scrap')"
                    >提交</el-button
                  >
                </el-form-item>
              </div>
    ...
    return {
      ...
      rules_Repair: {
        ...
        FailureTime: [
          ...
          { validator: checkWeixiuDate, trigger: 'blur' },
        ],
        FailureEndTime: [
          { required: true, message: '必填项', trigger: 'blur' },
        ],
  ...
  methods: {
    ...
    timePeriod(row, column, cellValue) {
      if (this.getCurrentDateday() > this.getCurrentDate3()) {
        if (row.failureTime >= this.getCurrentDate01()) {
          //getCurrentDate01:本月1号
        ...
        if (row.failureTime > this.getCurrentDate3()) {
          ...
          if (
            row.failureTime < this.getCurrentDate3() &&
            row.failureTime > this.getLastDate01()
          ) {
            //getLastDate01:上个月1号
            return `<i class="unlock" style="vertical-align: super;font-size: 30px;"><svg t="1614130652256" class="icon" viewBox="0 0 1448 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3130" width="32" height="32"><path d="M868.057993 437.736921H419.565235c-32.212778 0-58.320892 26.105681-58.320892 58.322108v425.769637c0 32.27481 26.108114 58.382924 58.320892 58.382925h606.019618c32.21886 0 58.266158-26.108114 58.266158-58.382925v-425.769637c-0.004865-32.21886-26.103249-58.322109-58.326973-58.322108H868.057993z m-112.727696 282.304548L755.329081 813.013843c0 4.152485-3.437295 7.655461-7.655461 7.655461h-50.133903c-4.270468 0-7.711411-3.502975-7.711412-7.655461v-92.972374c-23.553861-12.045127-39.868239-36.193764-39.868239-64.49732 0-40.045821 32.513207-72.618627 72.563893-72.618627 40.10542 0 72.623492 32.572806 72.623493 72.618627 0.053518 28.303555-16.259644 52.450976-39.817155 64.49732z" p-id="3131" fill="#1afa29"></path><path d="M932.254884 286.08241c0-80.218138 65.323194-145.541332 145.541332-145.541332 80.216921 0 145.424566 65.323194 145.424566 145.541332V437.738137h90.601784V282.229137c0-130.235275-105.850674-236.1419-236.083517-236.1419-130.234059 0-236.201499 105.906624-236.201499 236.1419V437.738137h90.717334V286.08241z" p-id="3132" fill="#1afa29"></path></svg></i>`
          } else {
    ...
    getDeviceFac() {
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_DeviceFactoryInfo/DeviceFactoryInfo_FindByPage?pageindex=1&pagesize=200',
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    getDevice() {
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_DeviceFactoryInfo/DeviceInfo_FindByPage?pageindex=1&pagesize=1000',
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    FacChange(val, valObj) {
      ...
      this.rateSPSelect = {
        ...
        selectUrl:
          this.api +
          '/api/Yw_DevUseRecord/GetDevSparePartInfo?City=' +
          this.ruleForm.PartCity +
          '&FacId=' +
          this.ruleForm.FacId,
        urlParams: JSON.stringify({}),
        optionKeys: JSON.stringify({
    ...
    selectChange(val, valObj) {
      ...
      switch (valObj.typeName) {
        case '6参数类型':
          ...
          this.getHostDevInfo({
            param: valObj.info,
            sstation: this.ruleForm.SStation,
          })
          break
        case '变更类型':
    ...
    getHostDevInfo(obj) {
      ...
      this.$http({
        ...
        .then((res) => {
          if (res.status == 200) {
            self.ruleForm.OriginDType =
              res.data.data[0].model != ''
                ? res.data.data[0].model
                : '暂无数据！'
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_DevUseRecord/GetList?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&StartTime=' +
          ...
          '&ChangeType=' +
          self.queryparam.ChangeType +
          '&ApplyState=' +
          self.queryparam.ApplyState +
          '&SStations=' +
          self.queryparam.chooseStationIds +
          '&WXJ30Day=' +
          self.queryparam.WXJ30Day,
      })
        .then((res) => {
          if (res.status == 200) {
    ...
    getList_Repair(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_DevUseRecord/GetList_Repair?pagesize=' +
          self.page_Repair.pageSize +
          '&pageindex=' +
          self.page_Repair.pageNo +
          '&Main_Model=' +
          self.queryparam_Repair.Main_Model +
          '&Main_Param=' +
          self.queryparam_Repair.Main_Param +
          '&SStations=' +
          self.queryparam.chooseStationIds1 +
          '&StartDate=' +
    ...
    getList_Scrap(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_DevUseRecord/GetList_Scrap?pagesize=' +
          self.page_Scrap.pageSize +
          '&pageindex=' +
          self.page_Scrap.pageNo +
          '&DeviceName=' +
          self.queryparam_Scrap.DeviceName +
          '&SStations=' +
          self.queryparam.chooseStationIds2,
      })
        .then((res) => {
          if (res.status == 200) {
        ...
        .then((res) => {
          if (res.status == 200) {
            ...
            if (self.ruleForm_Repair.RepairType != null) {
              self.rateWXSelect.model =
                self.ruleForm_Repair.RepairType.toString() //设备维修类型
            }
            self.ruleForm_Repair.Main_Param = res.data.data.main_Param
            if (self.ruleForm_Repair.Main_Param != null) {
              self.rateYSBSelect.model =
                self.ruleForm_Repair.Main_Param.toString() //6参数类型
            }
            self.ruleForm_Repair.Main_Model = res.data.data.main_Model
            self.ruleForm_Repair.FailureTime = res.data.data.failureTime
            self.ruleForm_Repair.FailurePhenomenon =
              res.data.data.failurePhenomenon
        ...
        .then((res) => {
          if (res.status == 200) {
            ...
            if (self.ruleForm_Scrap.ParamType != null) {
              self.rateYSBSelect.model =
                self.ruleForm_Scrap.ParamType.toString() //6参数类型
            }
    ...
    downloadExange(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_DevUseRecord/GetListDownLoad?pagesize=' +
          self.page.pageSize +
          '&pageindex=' +
          self.page.pageNo +
          '&StartTime=' +
    ...
    downloadWeixiu(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_DevUseRecord/GetList_RepairDownLoad?pagesize=' +
          self.page_Repair.pageSize +
          '&pageindex=' +
          self.page_Repair.pageNo +
          '&StartDate=' +
    ...
    downloadBaoFei(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/Yw_DevUseRecord/GetList_ScrapDownLoad?pagesize=' +
          self.page_Scrap.pageSize +
          '&pageindex=' +
          self.page_Scrap.pageNo +
          '&DeviceName=' +
