            ...
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item class="btn">
                <el-button
                  type="primary"
                  icon="el-icon-search"
                  v-has="'alarmRemind_handleSearch'"
                  @click="getList()"
                  >查询</el-button
                >
                <el-button
  ...
  methods: {
    ...
    getList(obj) {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/AlarmRemind/GetAllAlarmMessage?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          ' &SStaion=' +
    ...
    download() {
      ...
      this.$http({
        ...
        url:
          this.api +
          '/api/AlarmRemind/GetAllAlarmMessageDownLoad?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          ' &SStaion=' +
