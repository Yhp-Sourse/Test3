          ...
          <div class="search">
            <el-form :inline="true" class="demo-form-inline">
              <el-form-item label="统计类型：">
                <el-select
                  v-model:value="queryparam.StatisType"
                  placeholder="请选择统计类型"
                  style="width: 100%"
                >
                  <el-option
                    v-for="(item, index) in this.StatisTypeOptions"
                    :key="index"
                    :label="item.label"
                    :value="item.value"
                  ></el-option>
              ...
              <el-form-item class="btn">
                <el-button
                  type="primary"
                  icon="el-icon-search"
                  v-has="'alarmStatistics_handleSearch'"
                  @click="getList()"
                  >查询</el-button
                >
              </el-form-item>
  ...
  methods: {
    ...
    getList(obj) {
      ...
      if (self.queryparam.StatisType == '1') {
        ...
        urlStr =
          this.api +
          '/api/AlarmRemind/AlarmstatisticsByStation?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          ' &SStation=' +
          self.queryparam.peiZhiStationIds +
          ' &StartDate=' +
        ...
        urlStr =
          this.api +
          '/api/AlarmRemind/AlarmstatisticsByUnit?pageSize=' +
          self.page.pageSize +
          '&pageIndex=' +
          self.page.pageNo +
          ' &SStation=' +
