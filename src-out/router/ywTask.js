...
let ywTask = [
  {
    ...
    component: Vue.defineAsyncComponent(
      () => import('@/components/pages/ywTask/ywTask')
    ),
  },
  {
    path: '/ywTaskTotal',
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '任务统计',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywTaskTotal')
        ),
      },
      {
        path: '/index/ywPlan',
        name: '运维计划',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywPlan')
        ),
      },
      {
        ...
        name: '运维计划审核',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/YwPlanAduit')
        ),
      },
      {
        path: '/index/ywUnit',
      ...
      },
      {
        ...
        name: '运维人员',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywPerson')
        ),
      },
      {
        path: '/index/ywSignin',
        name: '考勤签到',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywSignin')
        ),
      },
      {
        ...
        name: '进站记录',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywArrivalRecord')
        ),
      },
      {
        path: '/index/ywWxts',
        name: '微信推送',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywWeChatPush')
        ),
      },
      {
        ...
        name: '停电记录',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywPowercut')
        ),
      },
      {
        ...
        name: '任务编辑',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywTaskDisplay')
        ),
      },
      {
        ...
        name: '检查计划',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywInspectionPlan')
        ),
      },
      {
        ...
        name: '检查计划窗口',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywInspectionPlanAdd')
        ),
      },
      {
        ...
        name: '检查计划审核',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywInspectionPlanJudge')
        ),
      },
      {
        ...
        name: '第四方检查任务',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywFourthInspectionTask')
        ),
      },
      {
        ...
        name: '第四方检查任务窗口',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywFourthInspectionTaskShow')
        ),
      },
      {
        ...
        name: '第四方任务整改',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywFourthInspectionJudge')
        ),
      },

      {
        ...
        name: '省站检查任务',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywProviceInspectionTask')
        ),
      },

      {
        ...
        name: '内部检查任务',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywInternalInspectionTask')
        ),
      },

      {
        ...
        name: '省站检查任务窗口',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywProviceInspectionTaskShow')
        ),
      },
      {
        ...
        name: '内部检查任务窗口',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywInternalInspectionTaskShow')
        ),
      },
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import('@/components/pages/ywTask/ywInternalInspectionTaskJudge')
        ),
      },
      {
        ...
        name: '省站任务整改',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywProviceInspectionTaskJudge')
        ),
      },
      {
        path: '/index/ywReport',
        name: '运维报告',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywReport')
        ),
      },
      {
        path: '/index/zgbg',
        name: '整改报告',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/zgbg')
        ),
      },
      {
        path: '/index/nbzgbg',
        name: '内部整改报告',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/nbzgbg')
        ),
      },
      {
        path: '/index/szzgbg',
        name: '省站整改报告',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/totalAnlysis/szzgbg')
        ),
      },
      {
        ...
        name: '电子表单一键导出',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/totalAnlysis/ExportFormOfOneKey')
        ),
      },
      {
        ...
        name: '电子表单一键导出2',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/totalAnlysis/ExportFormOfOneKey2')
        ),
      },
      {
        ...
        name: '运维表单存档',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/totalAnlysis/ExportFormUpload')
        ),
      },
      {
        ...
        name: '异常表单留痕',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywTask/ywAbnormalForm')
        ),
      },
    ],
  },
