    ...
    children: [
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import('@/components/pages/ywStatisticalAnaly/ywStationRanking.vue')
        ),
      },
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import('@/components/pages/ywStatisticalAnaly/ywUnitRanking.vue')
        ),
      },
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import('@/components/pages/ywStatisticalAnaly/ywPeopleRanking.vue')
        ),
      },
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import(
              '@/components/pages/ywStatisticalAnaly/ywMaintenanceReport.vue'
            )
        ),
      },
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import(
              '@/components/pages/ywStatisticalAnaly/maintenanceReportEdit.vue'
            )
        ),
      },
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import(
              '@/components/pages/ywStatisticalAnaly/ywMaintenanceStatistics.vue'
            )
        ),
      },
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import(
              '@/components/pages/ywStatisticalAnaly/patrolFormStatistics.vue'
            )
        ),
      },
      {
        ...
        name: '进站记录统计',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywStatisticalAnaly/ArrivalLogTotal')
        ),
      },
      {
        ...
        name: '统计表单缺失图片',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/totalAnlysis/lessFormFile')
        ),
      },
      {
        path: '/index/fileMgr',
        name: '文件管理',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/ywStatisticalAnaly/fileMgr')
        ),
      },
    ],
  },
