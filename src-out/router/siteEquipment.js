...
let siteEquipment = [
  {
    ...
    component: Vue.defineAsyncComponent(
      () => import('@/components/pages/siteEquipment/deviceOnlineInfo')
    ),
  },
  {
    ...
    component: Vue.defineAsyncComponent(
      () => import('@/components/pages/siteEquipment/deviceHostLibraryInfo')
    ),
  },
  {
    ...
    component: Vue.defineAsyncComponent(
      () => import('@/components/pages/siteEquipment/deviceFactoryInfo')
    ),
  },
  {
    ...
    component: Vue.defineAsyncComponent(
      () => import('@/components/pages/siteEquipment/deviceSparePartInfo')
    ),
  },
  {
    ...
    component: Vue.defineAsyncComponent(
      () => import('@/components/pages/siteEquipment/deviceLifeCycle')
    ),
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: Vue.defineAsyncComponent(
          () =>
            import('@/components/pages/siteEquipment/deviceLifeCycleDisplay')
        ),
      },
      {
        ...
        name: '设备使用',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/siteEquipment/devUseRecord')
        ),
      },
      {
        ...
        name: '仪器故障记录',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/siteEquipment/InstrumentFaultRecord')
        ),
      },
      {
        ...
        name: '标准气体',
        component: Vue.defineAsyncComponent(
          () => import('@/components/pages/siteEquipment/devStandardGas')
        ),
      },
    ],
  },
